---
slug: code-to-map
title: "Founder's Blog: Fused Code to Map. Instantly."
authors: [sina, isaac]
tags: [welcome]
image: './code-to-map-instantly.jpg'
---


Fused enables interoperability between geospatial datasets and tools in the modern data stack. It's a glue layer to integrate data platforms with data tools via a managed serverless API.
