...
See the full example in the [docs](https://docs.fused.io/tutorials/others/transform/generic/duckdb/#1-run-duckdb-in-a-fused-udf).
...
See the full example in the [docs](https://docs.fused.io/tutorials/others/transform/generic/duckdb/#3-integrate-duckdb-in-applications-using-fused).
