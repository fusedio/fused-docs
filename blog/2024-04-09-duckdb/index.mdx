...
1. [Run DuckDB in a Fused UDF](/blog/fly-berond-the-serverless-horizon/#1-run-duckdb-in-a-fusedudf)
2. [Call Fused UDFs from DuckDB](fly-berond-the-serverless-horizon/#2-call-fused-udfs-fromduckdb)
3. [Integrate DuckDB in applications using Fused](/blog/fly-berond-the-serverless-horizon/#3-integrate-duckdb-in-applications-usingfused)
