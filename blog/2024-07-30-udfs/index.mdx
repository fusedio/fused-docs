...
Fused [User Defined Functions (UDFs)](/core-concepts/why/) are powerful abstractions that modularize key operations that power geospatial applications. Here are three key aspects of Fused UDFs that make them particularly effective:
{/* truncate */}
