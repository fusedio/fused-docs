...
import ImageHomepage from '/blog/2024-09-02-dl4eo/fusedhome.png';

<div style={{textAlign: 'center'}}>
<img src={ImageHomepage} alt="File" style={{}} />
</div>
...
import ImageUdf1 from '/blog/2024-09-02-dl4eo/jeffudf.png';

<div style={{textAlign: 'center'}}>
<img src={ImageUdf1} alt="File" style={{}} />
</div>
...
import ImageUdf2 from '/blog/2024-09-02-dl4eo/jeffudf2.png';

<div style={{textAlign: 'center'}}>
<img src={ImageUdf2} alt="File" style={{}} />
</div>
...
import ImageUdf3 from '/blog/2024-09-02-dl4eo/jeffudf3.png';

<div style={{textAlign: 'center'}}>
<img src={ImageUdf3} alt="File" style={{}} />
</div>
...
import ImageUdf4 from '/blog/2024-09-02-dl4eo/jeffudf4.png';

<div style={{textAlign: 'center'}}>
<img src={ImageUdf4} alt="File" style={{}} />
</div>


Then, when we look at the result in the workbench, we get some issues at the border of the tiles.

import ImagePredicTileffect from '/blog/2024-09-02-dl4eo/tileffect.png';

<div style={{textAlign: 'center'}}>
<img src={ImagePredicTileffect} alt="File" style={{}} />
</div>
...
import ImagePredicTileFix from '/blog/2024-09-02-dl4eo/tileffectfix.png';
