...
Then, you can integrate this URL as the tile source in any mapping application. I am not diving into that here, but you can read how to do this in the [DeckGL Fused docs](/examples/out/deckgl/). You can check the code source of the demonstration below. Here is the extract of the JavaScript [Deck.gl](http://deck.gl/) code where the URL is integrated.
