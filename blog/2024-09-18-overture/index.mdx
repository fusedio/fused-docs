...
In this post, we’ll show how to enrich your dataset by matching it with the Overture Buildings theme using GERS IDs. This makes your dataset easier to visually inspect and more accessible for others to consume and integrate with their data.
...
While developing the UDF, the Fused UDF Editor allows us to visualize the output on the map dynamically.
