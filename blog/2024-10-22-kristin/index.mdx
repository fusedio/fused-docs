...
This block includes not only farmland but also trees, towns, and water bodies. Our challenge is to isolate the specific areas where corn is grown to enhance the precision of our analysis. Enter Fused: a tool with a [User Defined Function](/core-concepts/write/) (UDF) that reads the USDA cropland data layer, letting me specify the year and crop type to pinpoint corn accurately.

## Masking crop areas with a UDF

To tackle this, I created a Fused UDF that reads the USDA Cropland Data Layer. This allowed me to specify the year and crop type to identify of corn-growing regions. You can see the UDF code [here](https://www.fused.io/workbench/catalog/Crop_Mask_Zonal_Statistics-dc1e6bf9-e2e6-4a1b-9061-094bc4825978) and even clone it to your Fused workspace.
...
With Fused, merging spatial data is straightforward. Turn weak, unreliable data into a powerhouse of insights effortlessly.
