...
- **Parallel Execution:** UDFs can [run in parallel](/guide/getting-started/udf-best-practices/realtime#async-execution), processing thousands of data chips per minute for efficient scaling.
