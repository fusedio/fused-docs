...
🎥 Watch the Webinar recording associated with this blog post [here](https://www.youtube.com/watch?v=cyX75eS6s1M).
...
- **Remote Accessibility:** UDFs can be called from anywhere via [HTTP requests](/core-concepts/run-udfs/run-single-udfs/#http-requests), delivering data exactly where it's needed without the need to store or transfer large datasets.
