...
With these parameters, the simulation sampled "home" and "work" nodes, calculated start times, and determined the shortest paths between origins and destinations. [Async UDF calls](/guide/working-with-udfs/execution/realtime#async-execution) made the process parallelized and efficient. The final output was a GeoDataFrame with:
