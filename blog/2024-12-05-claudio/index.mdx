...
<ReactPlayer playsinline={true} className="video__player" playing={true} loop={true} muted={true} controls height="100%" url="https://fused-magic.s3.us-west-2.amazonaws.com/blog-assets/claudio.mp4" width="100%" />
