...
You first use leafmap to create a bounding box over an area of interest (AOI) `user_aoi` and create a GeoDataFrame `gdf_aoi` with it. Then, you can [run](/guide/getting-started/udf-best-practices/realtime) the [Overture Maps UDF](https://www.fused.io/workbench/catalog/Overture_Maps_Example-64071fb8-2c96-4015-adb9-596c3bac6787), passing the AOI as a parameter to define the area to fetch data for.
