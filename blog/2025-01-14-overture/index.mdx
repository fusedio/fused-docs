---
slug: create-a-workflow-to-enrich-your-datasets-with-overture-maps-data
title: "Create a workflow to enrich your datasets with Overture Maps data"
authors: [plinio]
...
In this tutorial we will showcase 2 simple Python workflows to "enrich" datasets with Overture Buildings data using a spatial join. This is an example of a simple enrichment operation that will help you understand how to work with Overture data in your own workflows.
