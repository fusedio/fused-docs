...
**TL;DR Maribel Hernandez shows how to create clusters of business categories using Overture Places data. Visualizing the spatial distribution of businesses in cities offers valuable insights into the inclusivity of urban networks.**
...
As someone who works with urban networks, my focus is on exploring how cities function and how their design impacts inclusivity. The core question driving this analysis is: Does the city have an even distribution of business services? Or are there shortages such as food deserts or unequal access to health facilities?
