...
<iframe 
    ...
    src="https://www.youtube.com/embed/_Im7OgLKp3g" 
...
<LazyReactPlayer playsinline={true} className="video__player" playing={true} muted={true} controls height="100%" url="https://fused-magic.s3.us-west-2.amazonaws.com/blog-assets/demo_blackprint_platform_short.mov" width="100%" />
