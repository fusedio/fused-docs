...
With Fused, it's easy to turn your UDF into an [HTTPS endpoint](/guide/data-input-outputs/export-api/tokens-endpoints). This enables you to [run the UDF](/guide/data-input-outputs/export-api/tokens-endpoints) it programmatically via HTTPS requests to integrate the functionality into various workflows and applications.
