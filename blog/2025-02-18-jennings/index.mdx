...
With Fused, it's easy to turn your UDF into an [HTTPS endpoint](/workbench/udf-builder/navigation/#share-snippets). This enables you to [run the UDF](/core-concepts/run-udfs/run-small-udfs/#https-requests) it programmatically via HTTPS requests to integrate the functionality into various workflows and applications.
