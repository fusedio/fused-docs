...
{/* Sharing your UDFs from Workbench has become simpler thanks to the dedicated "Share" button & redesigned page.  */}
...
- A default 90d cache time for all UDFs
- The ability to change the cache duration while creating or executing UDFs with the new `cache_max_age` argument
- The same control on cached function with the `@fused.cache` decorator for any Python Function
...
{/* TODO: Link to Fused 2.0 Changeloe */}
