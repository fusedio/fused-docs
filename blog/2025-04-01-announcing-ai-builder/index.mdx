...
**Fused AI Builder let's you create LLM Agents that can directly call & execute deployed Python code through [Fused UDFs](/guide/working-with-udfs/writing-udfs)!**
...
[MCP (Modal Context Protocol) Servers](https://modelcontextprotocol.io/introduction) allow Large Language Models like Claude or ChatGPT to directly make HTTPS queries. This means they can now access APIs and make all sorts of calls.
...
<div style={{ maxWidth: '800px', margin: '0 auto 2rem auto' }}>
  <iframe 
    ...
    src="https://www.youtube.com/embed/JOMiCDDX1kY" 
...
<Tabs className="unique-tabs">
  <TabItem value="internet-speed" label="Internet Speed of any location" default>
