...
# Inside Fused Apps: Python Workflows in The Browser

{/* TODO: Link to Apps Launch blogpost */}
...
<ReactPlayer
    ...
    width="100%"
    url="https://fused-magic.s3.us-west-2.amazonaws.com/workbench-walkthrough-videos/blogs/2025-05-13-inside-fused-apps/Vision_pro_panning_around_and_editing.mov"
/>
...
_You too can find out what Bunnies prefer by trying [this Fused App here](https://www.fused.io/app/UDF_Explore_CDL_app)_
...
![Backend engineer hiring](/img/blog/2025-05-20-inside-fused-apps/backend_engineer_open_role.png)