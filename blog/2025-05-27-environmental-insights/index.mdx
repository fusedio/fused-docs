...
<iframe 
    ...
    src="https://www.youtube.com/embed/ESokph_0660" 
...
By [building UDFs](/guide/working-with-udfs/writing-udfs) to manipulate each dataset, the team can iterate on their analysis in seconds while H3 allows them to more easily combine all the datasets together.
...
- [Colab Notebook](https://colab.research.google.com/drive/1F9SUD8aoYm2Ym6BArQ2bMISEx5xqKDHE?usp=sharing)


Sign up for a [free Fused account](https://www.fused.io/workbench) and try it out for yourself!
