...
Last week, we were at EO Summit, [Fused](https://www.fused.io/) came out of beta, officially launched our new site and opened for business in time for the event. 
...
But that’s all well and good when working on a small one-off project. But conferences like EO Summit keep showing that there’s more data than ever before, archives of imagery, 3D point clouds and any dataset keeps growing in scale, resolution & time backlog. Problems aren’t always local, limited to a small time & place. 
...
At CNG last month [Briana shared her story of the Los Angeles fires taking down her home](https://www.linkedin.com/pulse/when-our-community-burned-where-satellite-information-pag%C3%A1n-phd-8rxwf/?trackingId=PGMihonBbG7ShNl4LvW20g%3D%3D), and while having so much data available, so little was available quickly. This topic came again at this conference, wildfires being the prime example of the complexity of making timely use of data quickly in times of need despite having so much.
...
These conversations are directly going into our product development discussion, and as we write this developing tools to build these dashboard for rapid iteration is one of our biggest focus. Stay tuned for more on that soon! 
