...
tags: [announcements, ai chat]
image: /img/blog/2025-08-01-analytic-changing/udf.ai.png
...
We don’t think analysts, data engineers & scientists are going anywhere. We believe that [“AI won’t replace you, a human using AI will”](https://www.forbes.com/sites/reeceakhtar/2025/03/27/ai-wont-replace-you-a-human-using-ai-will/). AI amplifies the creativity and speed of the people already doing the work.
...
- **Code execution as validation**: AI code editors help write code, but can’t actually run it. At Fused we’re building on top of our [real time execution engine](/quickstart/data-science), so errors in code are spotted and fixed much faster, all in the same workflow.
...
![Three ways working with AI is changing analytics](/img/3_points_fused_overview.png)
...
We’ve since seen the term [Vibe Analytics](https://sloanreview.mit.edu/article/vibe-analytics-vibe-codings-new-cousin-unlocks-insights/) starting to pop up around, applying a similar approach but to analytics: leveraging LLMs to make it easier and faster to create analysis, make dashboards and share them to the rest of the team. 
...
|---------------|--------------------------------|-------------------------------------------------------|
| **Context**   | None, starting from scratch    | Rooted in existing data                               |
...
Help us build the [future of data analytics](https://fused.io/). Reach out to us directly (info@fused.io) or see our [open positions](https://www.fused.io/careers).

---
We did take inspiration from Andrej Karpathy's recent [Software is Changing (Again)](https://youtu.be/LCEmiRjPEtQ?si=TbwyWDJvJbgZNPKX) talk at AI Startup School, as you may have noticed from the title. 