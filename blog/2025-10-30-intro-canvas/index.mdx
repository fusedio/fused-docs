...
Today we're introducing Fused AI Canvas, a new way to organize your [UDFs](/core-concepts/write) on a free form canvas
...
Organize & move your [UDFs](/core-concepts/write) as you build your workflow on a free form canvas, allowing you to build analysis & workflows without being limited to a linear flow!
