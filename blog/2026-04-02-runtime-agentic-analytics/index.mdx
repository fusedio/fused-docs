...
## Why now: Agentic Analytics is possible
...
## A runtime for agentic analytics beyond endpoints: Parameterised Files
...
## Isolation & security (safe-by-default)
...
## Widgets as a non-hallucinating UI layer (JSON UI spec)
...
## Walkthrough: one end-to-end agentic workflow
...
You can [sign up to Fused](https://www.fused.io/) right now to try it out yourself, or directly [book a demo](https://calendly.com/max-fused/fused-demo-30min).
