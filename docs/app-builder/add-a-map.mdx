...
This section shows a few examples of how you can do that. While we do recommend you use [`pydeck`](/app-builder/app-map/#pydeck) (the Python implementation of [deck.gl](https://deck.gl/)) for its versatility, you can use other options like [`folium`](/app-builder/app-map/#folium)

:::note

    Note that you need to install dependencies with `micropip` inside your Fused app. More on [this here](app-builder/app-overview/#dependencies)
:::
...
:::note
    ...
    Read more about `fused.run` in the [dedicated section](/core-concepts/run/#fusedrun)
:::
