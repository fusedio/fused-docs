...
import ImageFileTile from '/img/filetile5.png';
...
import ImageFile from '/img/image-file.png';

<div style={{textAlign: 'center'}}>
<img src={ImageFile} alt="File" style={{width: 400,}} />
</div>
...
import ImageTile from '/img/image-tile.png';


<div style={{textAlign: 'center'}}>
<img src={ImageTile} alt="File" style={{width: 400}} />
</div>
