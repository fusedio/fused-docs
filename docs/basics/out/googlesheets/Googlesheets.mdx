...
github: 
  https://github.com/fusedio//fused-docs/blob/main/docs/basics/in/googlesheets.ipynb
colab: 
  https://githubtocolab.com/fusedio//fused-docs/blob/main/docs/basics/in/googlesheets.ipynb
---
...
<LinkButtons
  githubUrl="https://github.com/fusedio//fused-docs/blob/main/docs/basics/in/googlesheets.ipynb"
  colabUrl="https://githubtocolab.com/fusedio//fused-docs/blob/main/docs/basics/in/googlesheets.ipynb"
/>

# Google Sheets

The Google Sheets `importData` command imports data at from a given url in `.csv`
format. You can use it to load data from a UDF into a cell.
...
Now,
[create a signed Tile HTTP endpoint](/hosted-api/overview/#create-and-manage-shared-tokens-recommended)
for the UDF.
