...
This notebook is support material for the "DuckDB + Fused: Fly beyond the serverless
horizon"
[blog post](https://medium.com/@fused/duckdb-fused-fly-beyond-the-serverless-horizon-886d892834aa).
...
gdf = fused.run(udf=udf, x=2412, y=3078, z=13, engine='realtime')
gdf.head()
```
