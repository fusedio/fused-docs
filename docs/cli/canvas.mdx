...
| Flag | Description |
|---|---|
| `--output FILENAME` | Path to write the downloaded zip bundle. (default: `Sentinel.UNSET`) |
...
| Flag | Description |
|---|---|
| `--canvas TEXT` | Canvas name to push. (default: `Sentinel.UNSET`) |
| `--id` | Treat the provided reference as a canvas ID. |
...
| Flag | Description |
|---|---|
| `--skip TEXT` | Skip a named check. Repeatable. Checks: node_files, edge_refs, orphaned_files, widget_json_parse, widget_refs, widget_params. (default: `Sentinel.UNSET`) |
