...
This guide shows how to execute a batch job with [fused-py](/python-sdk/). It was inspired by a [Discord community request](https://discord.com/channels/1199097729243152434/1267578417411526788/1267578417411526788).


Running long processes can be computationally expensive, or liable to interruptions from browser **closures** or network issues. For these cases, [`fused-py`](/python-sdk/) can run batch jobs on an EC2 instance.
