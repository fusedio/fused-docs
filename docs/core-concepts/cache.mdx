...
Look into [ingesting your data](/tutorials/Geospatial%20with%20Fused/geospatial-data-ingestion/) in partitioned [cloud native formats](/tutorials/Geospatial%20with%20Fused/geospatial-data-ingestion/geospatial_file_formats/) if you're working with large datasets.
