...
:::tip
The line between when to ingest your data or use `@fused.cache` is a bit blurry. Check [this section](/core-concepts/data-ingestion/why-ingestion/#using-cache-as-a-single-use-ingester) for more
:::
