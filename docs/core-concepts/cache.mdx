...
- [Caching a STAC catalog request](/use-cases/dark-vessel-detection/#41-cleaning-our-sentinel-1-udf) when fetching Sentinel 1 radar satellite image in our Dark Vessel Detection example
...
### Caching & [`bounds`](/tutorials/Geospatial%20Analysis%20in%20Fused/filetile/#the-bounds-object)

Pass [`bounds`](/tutorials/Geospatial%20Analysis%20in%20Fused/filetile/#the-bounds-object) to make the output unique to each [Tile](/tutorials/Geospatial%20Analysis%20in%20Fused/filetile/#tile).
