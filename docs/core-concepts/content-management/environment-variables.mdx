...
Now, any UDF can load the values from `.env` as environment variables with the [`dotenv` library](https://pypi.org/project/python-dotenv/) and access them with [os.getenv](https://www.geeksforgeeks.org/python-os-getenv-method/).
