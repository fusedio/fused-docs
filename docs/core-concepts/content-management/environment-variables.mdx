...
First, run a [File UDF](/tutorials/Geospatial%20Analysis%20in%20Fused/filetile/#single-viewport) that sets variables in an `.env` file in the [`/mnt/cache/` directory](/core-concepts/content-management/file-system/#mntcache-disk).
