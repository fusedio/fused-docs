...
## Enable GitHub integration for your account

To enable the GitHub integration, you click on Preferences in the bottom left corner, then select "Enable GitHub Integration".

import ImageGit from '@site/static/img/enable_git.png';

<div style={{textAlign: 'center'}}>
<img src={ImageGit} alt="File" style={{width: 500}} />
</div>
...
import ImageGitDropdown from '@site/static/img/git_dropdown.png';
