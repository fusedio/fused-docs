...
{/* TODO: Missing context around _why_ users should do ingestion: who needs to do this, and why? Need info about more responsive UDFs + cloud native formats + geo-partitioned */}
