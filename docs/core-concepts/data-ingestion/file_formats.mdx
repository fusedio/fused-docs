...
- [Ingesting](/user-guide/examples/dark-vessel-detection/#34---ingest-1-month-of-ais-data-into-a-geo-partitioned-format) AIS point data from NOAA into GeoParquet format
