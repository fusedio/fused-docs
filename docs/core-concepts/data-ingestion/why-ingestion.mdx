...
<img src="/img/user-guide/examples/AIS_noaa_coast_portal.png" alt="Dark Vessel Detection AIS" style={{borderRadius: '12px', maxWidth: '90%', display: 'block', margin: '0 auto 20px'}} />
