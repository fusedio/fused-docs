...
Fused works with any file formats you might have, as all [UDFs](/core-concepts/write/) are running pure Python. This means you can use any file formats you want to store your own data. 
...
Take a look at [our benchmark](/core-concepts/data_ingestion/why-ingestion/#benchmark--demo) to see a comparison between loading a CSV, GeoParquet & Fused-partitioned GeoParquet to see a concrete example of this

To make the most out of Fused, we recommend [ingesting your data](/core-concepts/data_ingestion/ingestion-your-data/) into the following file formats:
