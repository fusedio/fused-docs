...
This endpoint structure runs a UDF as a `Single`. See implementation examples with [Felt](/user-guide/out/felt/#vector) and [Google Sheets](/user-guide/out/googlesheets/#2-create-a-url-for-the-udf) for vector.
