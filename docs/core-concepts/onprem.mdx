...
### 2. Configure Fused on the Docker container

Run the following in a Python environment within the container to configure the on-prem profile. Fused will provide values specific to your account via secure communication.
