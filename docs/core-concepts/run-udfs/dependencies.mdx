...
The simplest way to add your own library is to run the dedicated [Package Management Fused app](https://www.fused.io/workbench/apps/catalog/Package_Management-4c989719-b631-425a-bfcf-65b599b1c0c7). This app allows you to create a different environment and add any module you'd like

:::note
You need to make sure you have access to [Fused Apps](workbench/app-builder/) to be able to run this.
:::
