...
- [Scaling a large ingestion job](/user-guide/examples/dark-vessel-detection/#34---ingest-1-month-of-ais-data-into-a-geo-partitioned-format) of AIS point data
- [Ingesting a large amount of cropland data](/user-guide/examples/zonal-stats/#2-bring-in-your-data) for zonal statistics.