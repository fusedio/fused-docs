...
<details>
  <summary>Example job: saving to shared storage `/mount/`</summary>
    ...
    A common use case for offline jobs is as a "pre-ingestion" process. You can find a real-life example of this in our [dark vessel detection example](/use-cases/dark-vessel-detection/#32---writing-a-udf-to-open-each-ais-dataset)
...
- [Scaling a large ingestion job](/use-cases/dark-vessel-detection/#34---ingest-1-month-of-ais-data-into-a-geo-partitioned-format) of AIS point data
- [Ingesting a large amount of cropland data](/use-cases/zonal-stats/#2-bring-in-your-data) for zonal statistics.