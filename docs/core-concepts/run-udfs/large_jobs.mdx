...
To run a job from workbench, you can simply add an `instance_type` parameter to the [UDF decorator](/python-sdk/top-level-functions/#fusedudf) and run the UDF as usual from the udf builder page:
