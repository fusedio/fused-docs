...
Aim for a single UDF that takes 30-45s. This gives you a "safety" margin as UDFs will [timeout after 120s](/core-concepts/run-udfs/run/#running-udfs). So they can still take a bit longer and not time out. 
:::
