...
- 💡 Check the [Best Practices](/user-guide/best-practices/udf-best-practices/#run-tasks-in-parallel) for more on when to use `submit()` and when to use other methods.
