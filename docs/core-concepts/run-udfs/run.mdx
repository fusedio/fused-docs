...
<img src="/img/core-concepts/run-udfs/kernel_name_from_workbench.png" alt="Finding your kernel name in Workbench" style={{width: "60%", height: "auto", display: "block", margin: "0 auto", marginBottom: "20px"}} />
