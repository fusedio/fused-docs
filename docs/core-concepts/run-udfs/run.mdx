...
This is the safest way to call a UDF on Github, as you pin it to a specific hash version. 

```python showLineNumbers
commit_hash = "120a485"
output = fused.run(f"https://github.com/fusedio/udfs/tree/{commit_hash}/public/Single_point_Eiffel_Tower/")
```
