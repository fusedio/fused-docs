...
To run a UDF via HTTPS request, generate a [shared token](/workbench/udf-builder/navigation/#share) and use the provided URL. 
...
You can also pass parameters to your UDF via the URL by adding `&param=value` to the URL.
