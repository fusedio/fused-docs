...
<ReactPlayer playsinline className="video__player" loop playing={false} muted controls height="100%" width="100%" url="https://fused-magic.s3.us-west-2.amazonaws.com/workbench-walkthrough-videos/docs_rewrite/shared_token_edit.mp4" />
