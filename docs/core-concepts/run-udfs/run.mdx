...
If you want to quickly run a UDF a few times over a dataset or a list of inputs, you can use `PoolRunner`. Using a `lambda` function you can map the function to pass to `PoolRunner`:
