...
:::note
    `my_udf.to_fused()` saves your UDF to your personal user UDFs. These are private to you and our team. You can create a token than anyone (even outside your team) can use to run but by default these UDFs are private.
:::
