...
- ⛴️ [Retrieving 30 days]((/tutorials/Geospatial%20with%20Fused/use-cases/dark-vessel-detection/#33---run-this-udf-over-a-month-of-ais-data)) of AIS boat transponder data around the United States scale to detect illegal fishing
