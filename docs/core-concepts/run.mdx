...
## Caching responses
If a UDF's cache is [enabled](/workbench/udf-builder/code-editor/#cache), its endpoints cache outputs for each combination of code and parameters. The first call runs and caches the UDF, and subsequent calls return cached data.
