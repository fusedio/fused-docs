...
- The supported types for table are [`parquet`](/user-guide/out/duckdb/#3-query-using-read_parquet), [`geojson`](/user-guide/out/deckgl/#vector-tile-layers), [`json`](/user-guide/out/deckgl/#h3hexagonlayer), `feather`, [`csv`](/user-guide/out/googlesheets/), [`mvt`](user-guide/out/mapbox/#2-create-a-mapbox-html-map), `html`, `excel`, and `xml`.
