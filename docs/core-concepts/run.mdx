...
- **HTTP call** from *anywhere* (read more [here](/user-guide/out/http/))
- `fused.run()` in Python. All you need is [`fused` Python](/python-sdk/) package is installed
...
- The name or hash of the UDF you want to run
