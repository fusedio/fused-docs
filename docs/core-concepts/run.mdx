...
To run a UDF via HTTP request, generate a [shared token](/workbench/udf-builder/udf-editor/#share--snippets) then modify the provided URL. Manage your account's shared tokens in [fused.io/profile#tokens](https://www.fused.io/profile#tokens).
