...
{/* Or load one with [`fused.load`](/python-sdk/top-level-functions/#load) from GitHub or your account:

```python showLineNumbers
# Running a local UDF
loaded_udf = fused.load("https://github.com/fusedio/udfs/tree/main/public/REM_with_HyRiver/")
