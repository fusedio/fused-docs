...
- [From git commit hash (most recommended for teams)](/core-concepts/run/#git-commit-hash-recommended-for-most-stable-use-cases)
...
_When to use: Whenever you want to rely on a UDF such as in production or when using a UDF as a building for for another UDF._
