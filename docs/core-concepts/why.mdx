...
## The modern data science spaghetti

Once upon a time, Sina got annoyed he couldn't get things done fast enough at Uber. 

He went to ask Isaac to hook him up to one of the always-on machines at Uber, so he could run his analysis all the time, without worrying about compute. 

Eventually they leave Uber, but lose access to this always-on machine. Iteration speed of analysis goes down 

2 options from there:
- Either you pay $$$ to have an always on machine
- You pay $ but manage your machines up and down each time you need them, or have a team handle it for you

We don't think you should have to do this. 

That's why we build Fused UDFs: so writing & deploying code for 1 data point is 1 line of code as running it on the entire world
...
```
https://www.fused.io/server/v1/realtime-shared/UDF_eiffel_tower_point/run/file?dtype_out_vector=geojson
```

import ReactPlayer from 'react-player';

 <ReactPlayer className="video__player" playing={false} muted={true} controls height="100%" url="https://fused-magic.s3.us-west-2.amazonaws.com/workbench-walkthrough-videos/docs_rewrite/why-udfs/opening_udf_through_http.mp4" width="100%" />

{/* This probably needs a rewrite? I want a 1 liner than explains this code <-> file interaction */}
:::tip 
    This is the one of the powerful aspects of Fused: **You can write a Python UDF and interact with as a file!**
:::
