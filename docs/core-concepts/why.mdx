...
You can think of UDFs as versatile building blocks to load and transform data across a range of use cases, including geospatial. They can be used, for example, as virtual datasets, file readers, and workflow tasks.
