...
- 🔗 Shareable as HTTP endpoints in 2 clicks: Ship your work to the rest of the team
...
- 💻 UDFs work locally, but in 2 lines of code can be scaled to datasets the size of the world
- 🌍 UDFs can be called from anywhere: From a notebook, a frontend application or in a Notion page
...
- 🎓 Our [Examples](/user-guide/examples/): Real world examples of how to use UDFs
