...
If you want to ingest a small dataset we have a dedicated page to do this with a public UDF: [Raster to Hexagon](/user-guide/transform/geospatial/raster-h3/)
