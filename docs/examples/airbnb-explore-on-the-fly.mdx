...
*Walkthrough: Exploring Airbnb data with a Fused AI widget. [Try the Canvas](https://www.fused.io/canvas/fc_public/Airbnb_AI_Visualization)*
...
Open the [Fused Canvas](https://www.fused.io/canvas/fc_public/Airbnb_AI_Visualization) to explore the live Airbnb dataset, or go straight to the [interactive widget](https://www.fused.io/share/fc_5SyzybeWalreHjKfpAymBL/widget_2) to ask questions directly.
