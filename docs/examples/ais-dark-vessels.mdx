...
:::tip
    Most of the following section was written in [Workbench](/workbench/overview) rather than in Jupyter Notebooks.

    We'll have the code in code blocks, you can run these anywhere but as we're looking at images, it's helpful to have [Workbench's live map](/workbench/overview) updated as you write your code.
...
In Workbench we can now see the output of both of our UDF:
