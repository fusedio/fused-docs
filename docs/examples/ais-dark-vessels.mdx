...
Map Builder is deprecated and hidden by default. To follow along you can re-enable it under [Workbench Preferences](/workbench/preferences/) → **Deprecated features** → **Enable map view**. For new work, use the [Fused Map widget](/widget-api/fused-map) instead — see the [Widget API](/widget-api/overview) for all available widgets.
:::
