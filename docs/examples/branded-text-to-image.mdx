...
This is how the illustrations below were made: hand-drawn sketches converted to polished brand illustrations using a single shared style prompt.

<div style={{display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '24px'}}>
  <img src="/img/examples/branded-t2i/crime-style-ai-editors.png" alt="AI editors illustration in brand style" style={{width: '100%', borderRadius: '6px'}} />
  <img src="/img/examples/branded-t2i/crime-style-duckdb.png" alt="DuckDB illustration in brand style" style={{width: '100%', borderRadius: '6px'}} />
</div>
