...
def udf():
    import pandas as pd
    path = "s3://fused-asset/data/era5/t2m/datestr=2024-01-01/0.parquet"
...
Read more about [`fused.file_path()`](/python-sdk/api-reference/fused-file-path) and [mount](/guide/working-with-udfs/udf-best-practices/storage/#mntcache-disk)
...
<LazyReactPlayer url="https://fused-magic.s3.us-west-2.amazonaws.com/workbench-walkthrough-videos/docs_rewrite/examples/climate_dashboard/sharing_grpah.mp4" />
