...
We can expand the UDF we had started in [section 6.](/examples/dark-vessel-detection#6-retrieving-ais-data-for-our-time-of-interest) to call our AIS UDF by passing a bounding box + `s1_acquisition_month_day_hour_min`.
