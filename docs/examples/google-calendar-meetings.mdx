...
*Walkthrough: Checking whether you'll make your meetings on time using Fused and Claude. [Try the Canvas](https://www.fused.io/canvas/fc_public/Google_Calendar_routing) →*
...
Open the [Fused Canvas](https://www.fused.io/canvas/fc_public/Google_Calendar_routing) to explore the live pipeline. It connects to Google Calendar, calculates travel time between your events, and flags conflicts — ready for you to query with an AI agent.
