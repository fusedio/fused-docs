...
![Fetching Google Calendar events in Fused Canvas](/img/google-calendar-fetch-events.png)
...
![Querying the Fused API with Claude Code](https://fused-magic.s3.us-west-2.amazonaws.com/workbench-walkthrough-videos/api-gcal-gif.gif)
