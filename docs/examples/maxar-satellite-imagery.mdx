...
- Use [`fused.submit()`](/python-sdk/top-level-functions/#fusedsubmit) to run a [UDF in parallel](/guide/working-with-udfs/udf-best-practices/scaling-out#parallel-execution)
