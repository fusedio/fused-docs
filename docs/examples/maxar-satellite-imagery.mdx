...
Unpacking this UDF:
- This UDF takes :
    - a [`bounds`](/guide/working-with-udfs/udf-best-practices/geospatial-single-vs-tile#bounds) object. This allows us to pass the current [Workbench](/workbench/overview) map viewport to our UDF
