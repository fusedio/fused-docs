...
![PDF next to table](/img/tutorials/data-science-ai/pdf_next_to_workbench_table.png)
</div>

_Left: Original PDF. Right: DataFrame of PDF in Workbench_

Try out a [hosted app](https://www.fused.io/server/v1/realtime-shared/fsh_1IH3QxpoAIEz9qtUChfqtS/run/file) for yourself:
...
<iframe 
    ...
    title="PDF Table to CSV Extractor"
    allowFullScreen>
</iframe>
...
<div style={{textAlign: 'center'}}>
![AI Assistant searching for PDFs](/img/tutorials/data-science-ai/pdf_search_ai.png)
</div>
...
<div style={{textAlign: 'center'}}>
![Census table data](/img/tutorials/data-science-ai/census_table_data.png)
</div>
...
<div style={{textAlign: 'center'}}>
![Output DataFrame from PDF parsing](/img/tutorials/data-science-ai/output_df_from_pdf_parsing.png)
</div>

{/* TODO: You'd need to be in Wb for this to work though, need to change how this is explained */}
You may notice the table has some formatting issues. These can be fixed relatively easily by asking the [AI Assistant](/workbench/ai-assistant/) to fix them.

### Build it yourself

You can make a copy of the UDF from the [UDF Explorer](https://www.fused.io/workbench/udf/catalog/datalab_pdf_to_json_to_df-50eb6624-16b9-4347-9170-3a462b264357)
...
<div style={{textAlign: 'center'}}>
![PDF to DataFrame in Workbench](/img/tutorials/data-science-ai/workbench_pdf_to_df.png)
</div>

## Next Steps

Now that you have a DataFrame you can explore how to build on top:
- Ask AI to [visualize the data](/guide/working-with-udfs/building-outputs/dashboards)
- See how to turn [any of your UDFs into an API endpoint](/guide/data-input-outputs/export-api/tokens-endpoints)
- Let anyone talk to this data [through MCP Servers](/guide/data-input-outputs/export-api/mcp-servers)