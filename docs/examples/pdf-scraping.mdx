...
- Add `datalab` as a secret in the [Preferences](/reference/workbench/preferences#secrets-management)
...
- Ask AI to [visualize the data](/guide/building-apps/)
- See how to turn [any of your UDFs into an API endpoint](/tutorials/Engineering%20&%20ETL/turn-your-data-into-an-api)
