...
<div style={{textAlign: 'center'}}>
![AI Chat searching for PDFs](/img/tutorials/data-science-ai/pdf_search_ai.png)
</div>
...
You may notice the table has some formatting issues. These can be fixed relatively easily by asking the [AI Chat](/workbench/ai-chat/) to fix them.
