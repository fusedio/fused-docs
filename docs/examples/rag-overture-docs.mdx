...
Once the search UDF is live as a Fused API endpoint, you can connect it to Slack so your team can query the docs directly from a channel. The [Fused Slack integration](/workbench/integrations/slack) lets you wire any UDF endpoint to a Slack bot — no extra infrastructure needed.
...
- [Slack integration](/workbench/integrations/slack) — route search queries through a Slack bot
