...
[![RAG pipeline Canvas overview](/img/tutorials/rag-overture-docs/canvas_overview.png)](https://www.fused.io/canvas/fc_fused/Ragging_Overture_Docs)

*[Try it out on Fused Canvas](https://www.fused.io/canvas/fc_fused/Ragging_Overture_Docs) →*
...
[Try the full pipeline on Fused Canvas](https://www.fused.io/canvas/fc_fused/Ragging_Overture_Docs) to see all four UDFs wired together.
