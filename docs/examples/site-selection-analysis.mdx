---
id: site-selection-analysis
title: Site Selection Analysis
sidebar_label: Site Selection Analysis
sidebar_position: 10
---
...
![Downloading Starbucks data from Kaggle](/img/tutorials/data-science-ai/starbucks_kaggle_download.png)
...
Create 1 UDF per dataset to explore them as individual layers on the [Map View](/workbench/udf-builder/canvas). 
...
![Stores and Census Block Groups in Sacramento](/img/tutorials/data-science-ai/stores_and_block_groups.png)


## Creating isochrones

The Fused [AI Chat](/workbench/ai-chat/) uses other UDFs as inspiration to adapt existing code for new use cases.
...
<LazyReactPlayer url="https://fused-magic.s3.us-west-2.amazonaws.com/workbench/walkthrough-videos/docs_rewrite/catchments_from_get_isochrone_compressed2.mp4" />
...
![AI suggesting to create a chart from the dataframe](/img/tutorials/data-science-ai/create_a_chart.png)

This visualizes the results:

![Starbucks location ranking showing population, income, competition and cannibalization metrics](/img/tutorials/data-science-ai/starbucks_location_ranking.png)
...
- Scale to entire US using [`fused.submit()`](/guide/working-with-udfs/udf-best-practices/scaling-out#parallel-execution)
