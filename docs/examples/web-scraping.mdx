...
When you need to scrape data from multiple known URLs simultaneously, use the [scrapegraph multi scraper UDF](https://www.fused.io/workbench/udf/catalog/scrapegraph_multi_scraper-8aaafa63-3888-4f12-8d31-6e3f9098b2ae). This UDF creates a unified output schema across all pages and processes them in parallel using [fused.submit](/python-sdk/api-reference/submit) calls.
