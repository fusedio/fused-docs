...
We hope this overview gives you a glimpse of what you can build with Fused. You can continue to learn how to [read data](/guide/data-input-outputs/read-write/geospatial/reading), [process data](/guide/working-with-udfs/caching), and [integrate](/guide/data-input-outputs/export-api/geospatial-export) with other applications.
