...
2. **Running a [cached UDF](/guide/working-with-udfs/caching/)**: If you're running a UDF that was cached (rerunning the same UDF with the same parameters), no memory was used. 
