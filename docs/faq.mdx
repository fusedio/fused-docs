...
Fused batch jobs, which are initiated with [run_batch](/python-sdk/api-reference/ingest#jobrun_batch), require a server quota to be enabled for your account. These include data [ingestion](/guide/data-input-outputs/read-write/geospatial/ingestion) jobs. If you encounter this error, please contact the Fused team to request an increase in the quota allotted to your account.
</details>
