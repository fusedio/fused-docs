...
<details>
<summary>Github Integration is not working</summary>

- Make sure to have [enabled Github Integration](/core-concepts/content-management/git/#enabling-github-integration) in [Preferences](/workbench/preferences/).
- Default branch names of your repo must be `main`. 
