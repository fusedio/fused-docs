...
To keep things simple, Fused maintains a single runtime image. This means that any UDF you [run](/guide/working-with-udfs/execution/realtime) will be executed with these dependencies by default
