...
First, run a [File UDF](/guide/working-with-udfs/geospatial/single-vs-tile#single-udf) that sets variables in an `.env` file in the [`/mnt/cache/` directory](/guide/advanced-setup/file-system/#mntcache-disk).
