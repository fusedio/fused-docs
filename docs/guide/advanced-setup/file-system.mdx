...
Fused provides two file systems to make files accessible to all UDFs: an [S3 bucket](/guide/advanced-setup/file-system/#fd-s3-bucket) and a [disk](/guide/advanced-setup/file-system/#mntcache-disk). Access is scoped at the organization level.
