...
<Tag color="#3399ff">Developer, Professional and Enterprise</Tag> _Integrating private repositories is accessible to organizations with a Fused Developer, Professional & Enterprise subscription (see [Plans](https://www.fused.io/pricing))._
...
- [Version Control](/guide/working-with-udfs/udf-best-practices/version-control) — how to version control your UDFs
