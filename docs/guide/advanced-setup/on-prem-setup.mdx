...
Fused offers an on-premise deployment option for enterprise customers who need to keep data behind their own firewall. An on-prem deployment gives you the full Fused platform — [Workbench](/workbench/overview), the [Python SDK](/python-sdk/overview), [HTTP endpoints](/guide/data-input-outputs/export-api/tokens-endpoints), and serverless UDF execution — running entirely inside your AWS account.
