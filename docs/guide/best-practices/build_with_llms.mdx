...
#### 1. Install `fused` [locally](/reference/python-sdk/#python-install). 
...
You also need to be [logged in](/reference/python-sdk/#python-install) to your Fused account for Cursor to be able to save UDFs to Workbench for you. You can test this with:
