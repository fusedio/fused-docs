...
In Canvas, create a simple UDF that returns a GeoDataFrame or a DataFrame with [hex cells](/tutorials/Geospatial%20with%20Fused/h3-tiling).
...
- Create real time filtering maps with [DuckDB WASM](/tutorials/Analytics%20&%20Dashboard/realtime-data-processing-with-duckdb-wasm)
...
- [Tiled data](/reference/udf-patterns/bounds-and-tiles#tile-udf) for any dataset too large to serve as a single file
