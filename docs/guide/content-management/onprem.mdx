...
description: Run Fused in your own computing environment with Docker
---
...
Step 1: Open [Fused Workbench](/reference/workbench/udf-builder/code-editor), create a "New UDF" and copy this UDF to Workbench:
...
The on-prem container can be configured with the following environment variables.
