...
# Write
df.to_parquet("s3://fused-user/fused/aman/my-data/output.parquet")  # change to your own path
```
...
# Write
gdf.to_parquet("s3://fused-user/fused/aman/my-data/output.parquet")  # change to your own path
```
...
# Write
gdf.to_file("s3://fused-user/fused/aman/my-data/output.geojson", driver="GeoJSON")  # change to your own path
```
...
|----------|--------|---------|
| Fused home directory | `s3://` | `s3://fused-user/fused/aman/my-data/file.parquet` |
