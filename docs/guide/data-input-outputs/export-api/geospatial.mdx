...
1. Create a UDF, [share your canvas](/workbench/udf-builder/canvas#share-modal) to get a canvas token, then use the [HTTPS endpoint](/guide/data-input-outputs/export-api/tokens-endpoints) format above.
