...
Optinally, edit the URL for your preferred format, `.json`, `.csv`, etc. (see [Calling UDFs as API](/guide/working-with-udfs/run-udfs-as-api)):
...
If you rename a UDF, the old URL (with the previous name) stops working.
:::
