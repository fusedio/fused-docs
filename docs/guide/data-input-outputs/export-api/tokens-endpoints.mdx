...
<Tabs className="unique-tabs">
  <TabItem value="canvas" label="Canvas" default>
    ...
    1. Select the UDF you want to share, click the 3 dots, "Open In..." and select "Share link".

    ![Canvas Share](/img/workbench/canvas/sharing_udf.png)

    2. Optionally: Select another format in "Copy Data URL" or edit the URL to return the data in your preferred file format (See [Dynamic File API](/guide/data-input-outputs/export-api/dynamic-file-api) for more details).
  ...
  <TabItem value="advanced-udf-editor" label="Advanced UDF Editor">
    ...
    2. Click the 3 dots and select "URL"

    Optionally: Edit the URL to return the data in your preferred file format (See [Dynamic File API](/guide/data-input-outputs/export-api/dynamic-file-api) for more details).
...
- Manage your account's shared tokens [in the Workbench Tokens page](https://www.fused.io/workbench/tokens).
- Learn more in the dedicated [Dynamic File API](/guide/data-input-outputs/export-api/dynamic-file-api) page.
