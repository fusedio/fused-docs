...
<Tabs className="unique-tabs">
  <TabItem value="udf-editor" label="UDF Editor" default>
    ...
    2. Optionally: Edit the URL to return the data in your preferred file format. (See [Calling UDFs as API](/guide/working-with-udfs/calling-udfs-as-api) for more details)
...
See [Calling UDFs as API](/guide/working-with-udfs/calling-udfs-as-api) for more details.
...
See the full list of supported formats in [Calling UDFs as API Output Formats](/guide/working-with-udfs/calling-udfs-as-api#output-formats).
