...
title: Canvas as MCP Server
sidebar_label: Canvas as MCP Server
sidebar_position: 6
---
...
The [AI_and_RAG](https://www.fused.io/canvas/fc_fused/AI_and_RAG) canvas is already set up as a public example — run the command below to connect it and follow the steps:
```bash
claude mcp add --transport http fused-AI_and_RAG \
...
:::tip Try a live example
Open the [AI_and_RAG](https://www.fused.io/canvas/fc_fused/AI_and_RAG) canvas to see the `ai-chat` widget connected to a live UDF.
:::
