...
Connect Fused to external databases like Snowflake, BigQuery, and Google Earth Engine.

## Snowflake

Set `user` and `password` in the Fused [secrets management UI](/reference/workbench/preferences#secrets-management) first.
