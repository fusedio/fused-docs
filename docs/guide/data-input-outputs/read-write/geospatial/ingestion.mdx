...
This makes it fast to read for any UDF, so developing in [Workbench](/workbench/overview) & [running UDFs](/guide/working-with-udfs/udf-best-practices/realtime) is a lot faster & responsive!
