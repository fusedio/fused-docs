...
Ingestion jobs often take more than a few seconds and require a lot of RAM, making [this a large run](/guide/working-with-udfs/udf-best-practices/batch-jobs#when-to-use-batch). Use `run_batch()` so your ingestion job can take as long as needed.
