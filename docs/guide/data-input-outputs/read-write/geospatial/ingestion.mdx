...
Ingestion jobs often take more than a few seconds and require a lot of RAM, making [this a large run](/guide/working-with-udfs/execution/batch-jobs#defining-batch-jobs). Use `run_batch()` so your ingestion job can take as long as needed.
