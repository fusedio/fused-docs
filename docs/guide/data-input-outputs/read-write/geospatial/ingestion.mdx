...
The example below uses [Overture Maps](https://overturemaps.org/) buildings to show how to read only a subset of data for a small area. [Try it on Fused Canvas →](https://www.fused.io/canvas/fc_fused/AI_and_RAG)
