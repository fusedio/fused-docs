...
def udf():
    ...
    output_path = "s3://fused-user/fused/aman/subway_stations.parquet"  # change to your own path
...
job = fused.ingest(
    ...
    output="s3://fused-user/fused/aman/data/census/partitioned/",  # change to your own path
)
