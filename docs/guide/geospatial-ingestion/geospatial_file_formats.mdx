...
:::note
Take a look at [our benchmark](/tutorials/Geospatial%20with%20Fused/geospatial-data-ingestion/why-ingestion/#benchmark--demo) to see a comparison between loading a CSV, GeoParquet & Fused-partitioned GeoParquet to see a concrete example of this
:::

To make the most out of Fused, we recommend [ingesting your data](/tutorials/Geospatial%20with%20Fused/geospatial-data-ingestion/ingest-your-data) into the following file formats:
...
:::tip
    Refer to the [next section](/tutorials/Geospatial%20with%20Fused/geospatial-data-ingestion/ingest-your-data) to see all the details of how to ingest your data with Fused's built-in `fused.ingest()` to make the most out of geoparquet
:::
