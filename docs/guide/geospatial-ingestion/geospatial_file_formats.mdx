...
sidebar_position: 3
description: Cloud-optimized formats for geospatial data (GeoParquet, COG)
---
...
Fused works with any file formats you might have, as all [UDFs](/guide/running-udfs/writing-udfs) are running pure Python. This means you can use any file formats you want to process your data.
...
:::note
Take a look at [our benchmark](/guide/geospatial-ingestion/why-ingestion#benchmark--demo) to see a comparison between loading a CSV, GeoParquet & Fused-partitioned GeoParquet to see a concrete example of this
:::

To make the most out of Fused, we recommend [ingesting your data](/guide/geospatial-ingestion/ingest-your-data) into the following file formats:
...
:::tip
    Refer to the [Ingest Your Data](/guide/geospatial-ingestion/ingest-your-data) page to see all the details of how to ingest your data with Fused's built-in `fused.ingest()` to make the most out of geoparquet
:::
...
- [Ingesting](/guide/use-cases/dark-vessel-detection#34---ingest-1-month-of-ais-data-into-a-geo-partitioned-format) AIS point data from NOAA into GeoParquet format
