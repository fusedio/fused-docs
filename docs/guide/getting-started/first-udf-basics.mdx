...
Every UDF is a dynamic file system. Share your [canvas](/workbench/udf-builder/canvas#share-modal) to get a canvas token; then each UDF is available by name.
...
Renaming a UDF in Workbench changes its URL; the old URL will no longer work. Learn more about [Calling UDFs as API](/guide/working-with-udfs/run-udfs-as-api).
