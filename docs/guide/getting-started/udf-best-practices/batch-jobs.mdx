...
Batch jobs are for UDFs that need more time or resources than [realtime execution](/guide/getting-started/udf-best-practices/realtime).

## When to use batch

Use batch when your UDF exceeds [realtime limits](/guide/getting-started/udf-best-practices/realtime#realtime-limits):
