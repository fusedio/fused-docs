...
For [**realtime UDFs**](/guide/working-with-udfs/execution/realtime), you also get two fix options:
- **Deep Fix** — Opens AI Tab for larger changes
- **Quick Fix** — Inline edit on the lines around the error

For [**batch jobs**](/guide/working-with-udfs/execution/batch-jobs), only the error summary is shown.
