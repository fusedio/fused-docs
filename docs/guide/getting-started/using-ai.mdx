...
- Customizing templates (like [standalone maps](/examples/building-outputs/standalone-maps) or [charts](/examples/building-outputs/charts))
...
For [**batch jobs**](/guide/working-with-udfs/udf-best-practices/batch-jobs), only the error summary is shown.
