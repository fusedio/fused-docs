...
_Tips & Tricks for making [Fused Workbench](/workbench/overview) work for you_

import ReactPlayer from 'react-player';

![Workbench Overview](/img/user-guide/best-practices/new_workbench.png)

[Workbench](/workbench/overview) is a web-IDE built to make working with Fused UDFs even faster! 
...
### 💡 Leverage all the [UDF Best Practices](/guide/working-with-udfs/writing-udfs)

While this page is for Workbench, it builds on top of all the [Best Practices](/guide/working-with-udfs/writing-udfs) that make your UDF fast & efficient. So if you haven't yet, take a look at our [dedicated UDF Best Practices](/guide/working-with-udfs/writing-udfs).
...
Your team can load your own UDFs by calling it with a [team udf name](/guide/working-with-udfs/execution/realtime#team-udf-names) so be sure to give it an explicit name!
...
You can use [Canvas](/workbench/udf-builder/canvas/) to organise your UDFs into different projects. This allows you to:
