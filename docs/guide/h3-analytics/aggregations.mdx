...
After ingesting a dataset to [H3 hexagons](/guide/h3-analytics/converting#ingesting-dataset-to-h3) it's possible to [visualize it in Fused](/guide/h3-analytics/visualization) but we can also directly work with the data.
...
def udf(
    ...
    hex_reader = fused.load("https://github.com/fusedio/udfs/tree/9780aef/community/joris/Read_H3_dataset/")
...
You can already use the [h3_reader.read_h3_dataset](https://github.com/fusedio/udfs/tree/9780aef/community/joris/Read_H3_dataset/) and specify:
...
<LazyReactPlayer wrapperStyle={{ maxWidth: "800px", margin: "0 auto 2rem auto" }} loop url="https://fused-magic.s3.us-west-2.amazonaws.com/workbench-walkthrough-videos/docs_rewrite/tutorials/geospatial/h3_aggregate_different_res_compressed.mp4" />
...
You can also create derivative layers by writing custom logic after reading data using the [h3_reader.read_h3_dataset](https://github.com/fusedio/udfs/tree/9780aef/community/joris/Read_H3_dataset/)

Example: Calculating slope from elevation

<LazyReactPlayer wrapperStyle={{ maxWidth: "800px", margin: "0 auto 2rem auto" }} loop url="https://fused-magic.s3.us-west-2.amazonaws.com/workbench-walkthrough-videos/docs_rewrite/tutorials/geospatial/elevation_to_slope_compressed.mp4" />
