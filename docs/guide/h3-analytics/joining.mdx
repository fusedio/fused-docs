...
- Use `hex` as the H3 hexagon column name (as would be the case for any [ingested H3 dataset](/guide/h3-analytics/ingesting-dataset-to-h3) through Fused)
...
Using the example from the previous ["Aggregate"](/guide/h3-analytics/analysis-with-h3/aggregating-h3-data) section, we can join the elevation & crop data layer together.
