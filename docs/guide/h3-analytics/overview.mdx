...
|------|-----------|----------------------|-----------|---------------|
| [File to H3](/guide/h3-analytics/vector-to-h3#file-to-h3-points) | Small (< 100MB) | On the fly | Static Resolution | Easy to adjust. Can easily change field to hexagonify |
| [Dynamic Tile to H3](/guide/h3-analytics/vector-to-h3#dynamic-tile-to-h3) | Small or Large | On the fly | Dynamic Resolution | Easy to adjust. Can easily change field to hexagonify |
| [Ingesting dataset to H3](/guide/h3-analytics/raster-to-h3) | Large (> 100MB) | Pre-computed | Dynamic Resolution | Requires deciding on which variable to hexagonify ahead of time |
