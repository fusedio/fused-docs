...
def udf(
    ...
    data_url: str = "https://www.fused.io/server/v1/realtime-shared/fc_4z5GlcnyFckILQtVszIOzZ-join_era5_cdl_elevation/run/file?dtype_out_raster=png&dtype_out_vector=parquet",
    theme: str = "workbench",
...
def udf(
    ...
    # USDA CDL classification code -> crop name (see the full table at
    ...
    crop_mapping = {
        ...
        24: "Winter Wheat", 36: "Alfalfa", 54: "Tomatoes", 69: "Grapes",
        141: "Deciduous Forest", 176: "Grass/Pasture",
        # ... remaining USDA CDL codes
    }
