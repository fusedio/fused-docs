...
:::note Set your UDF to [Tile UDF Mode](/reference/udf-patterns/bounds-and-tiles#tile-udf)

The examples in this page all use the [Tile UDF Mode](/reference/udf-patterns/bounds-and-tiles#tile-udf) to dynamically compute H3 based on the viewport bounds.

Read more about the differences between [Tile UDF Mode](/reference/udf-patterns/bounds-and-tiles#tile-udf) and [Single UDF Mode](/reference/udf-patterns/bounds-and-tiles#single-udf).
...
- Passing the [viewport `bounds`](/reference/udf-patterns/bounds-and-tiles#bounds)
...
We built a [custom Map UDF template](https://www.fused.io/workbench/catalog/Hex_Tile_Map_Template-f9e91177-3225-4cf5-ab07-7b5d10b6bdff) that takes in H3 hexagons and renders them on a map.
