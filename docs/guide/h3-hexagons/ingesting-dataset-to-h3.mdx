...
to an H3 dataset, through [`fused.h3.run_ingest_raster_to_h3()`](/reference/python-sdk/api-reference/h3/#fusedh3run_ingest_raster_to_h3).
...
Important to understand is that the [`run_ingest_raster_to_h3`](/reference/python-sdk/api-reference/h3/#fusedh3run_ingest_raster_to_h3) function will run
...
The [`run_ingest_raster_to_h3`](/reference/python-sdk/api-reference/h3/#fusedh3run_ingest_raster_to_h3) function will write a set of files to the specified
output directory:
...
The [`run_ingest_raster_to_h3`](/reference/python-sdk/api-reference/h3/#fusedh3run_ingest_raster_to_h3)
...
[`run_ingest_raster_to_h3()`](/reference/python-sdk/api-reference/h3/#fusedh3run_ingest_raster_to_h3)
call.
...
Further keywords of [`fused.submit()`](/reference/python-sdk/top-level-functions/#fusedsubmit)
