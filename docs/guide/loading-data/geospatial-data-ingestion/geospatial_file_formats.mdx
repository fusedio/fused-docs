...
:::tip
    Refer to the [next section](/guide/geospatial-ingestion/ingest-your-data) to see all the details of how to ingest your data with Fused's built-in `fused.ingest()` to make the most out of geoparquet
:::
