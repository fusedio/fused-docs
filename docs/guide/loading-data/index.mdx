...
| Source | Guide |
|--------|-------|
| CSV, Parquet, GeoJSON, Shapefiles | [Local Files](/guide/loading-data/local-files) |
| S3, GCS, Azure Blob | [Cloud Storage](/guide/loading-data/cloud-storage) |
| Snowflake, BigQuery, Postgres | [Databases](/guide/loading-data/databases) |
| REST APIs, STAC Catalogs | [APIs & STAC](/guide/loading-data/apis) |
| Google Earth Engine | [Google Earth Engine](/guide/loading-data/gee) |
| Format recommendations | [File Formats Guide](/guide/loading-data/file-formats) |
...
Set credentials in [Secrets Management](/reference/workbench/preferences#secrets-management):
...
> 📚 **Reference:** See [Data Loading Reference](/reference/data-loading/) for all file format examples.
