...
- **[Multi-Processing](/guide/working-with-udfs/fused-submit)**: Real-time Python engine for immediate Python runtime
- **[AI Editor](/workbench/ai-chat/)**: Unlike AI code editors, Fused has access to your data's structure and context
