...
Fused is built for data teams that want to get work done quickly — in a world where data lives in different formats and places, and where AI is everywhere.

<img src="/img/what-is-fused/header.jpg" alt="What is Fused" style={{width: '75%', display: 'block', margin: '20px auto'}} />
...
- **Connect** — Crawl any docs site via its sitemap, parallelise fetching and cleaning all pages into a single `llms.txt` file saved to S3.
