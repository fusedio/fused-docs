...
#### 1. Install `fused` [locally](/reference/python-sdk/#installation). 
...
You also need to be [logged in](/reference/python-sdk/#installation) to your Fused account for Cursor to be able to save UDFs to Workbench for you. You can test this with:
