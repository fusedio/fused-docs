...
You can easily change the styling of your data in the [Visualization](/workbench/udf-builder/styling) panel:
- [Changing the color of your data](/workbench/udf-builder/styling#color-styling-methods-getfillcolor) (especially for vector files)
- Using Visualize presets under "Preset"
- [Creating your own custom `loadingLayer`](/workbench/udf-builder/styling#debug-layers-debugtilelayer)
