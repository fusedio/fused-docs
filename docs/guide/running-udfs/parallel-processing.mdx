...
- Read the [Best Practices](/guide/best-practices/udf-best-practices/#writing-efficient-udfs) page for more tips on writing efficient UDFs
...
- 📈 Processing 20Tb of data in minutes: [Making a Climate Dashboard](/guide/use-cases/climate-dashboard/) of 20 years of data
- ⛴️ [Retrieving 30 days](/guide/use-cases/dark-vessel-detection/#33---run-this-udf-over-a-month-of-ais-data) of AIS boat transponder data around the United States to detect illegal fishing
- 🛰️ [Retrieving all of Maxar's Open Data STAC Catalogs](/guide/use-cases/exploring_maxar_data/#preparing-fusedsubmit-to-run-in-parallel) across every events they have imagery for.

💡 Check the [Best Practices](/guide/best-practices/udf-best-practices/#run-tasks-in-parallel) for more on when to use `submit()` and when to use other methods.
