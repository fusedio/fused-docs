...
- [UDF Best Practices](/guide/running-udfs/best-practices/udf-best-practices)
    ...
    - Type your inputs
- [Workbench Best Practices](/guide/running-udfs/best-practices/workbench-best-practices)
    - [Use `return` to quickly explore data](/guide/running-udfs/best-practices/workbench-best-practices#use-return-to-quickly-explore-data)
    - [Visualization tips](/guide/running-udfs/best-practices/workbench-best-practices#%EF%B8%8F-visualizing-results)
