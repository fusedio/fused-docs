...
description: Tips and best practices to verify your analysis in Fused
---
...
Related docs:
- Use Canvas to create [standalone maps](/guide/building-apps/standalone-maps) of datasets
- [Canvas Catalog](/guide/use-cases/canvas-catalog): Example of Fused Canvases using standalone maps

## Compare Results in UDF Builder view

The [UDF Builder view](/reference/workbench/udf-builder/) allows you to visualize multiple layers of data at once. This is a great way to QA your data.
...
- You want to get a quick look at the data at scale by leveraging the [Tile mode](/reference/udf-patterns/bounds-and-tiles#tile-udf)
- You don't need a shareable visualization but simply want to visually inspect your data as part of your QA process

Related docs:
- [UDF Builder view](/reference/workbench/udf-builder/)
- [Single / Tile UDFs](/reference/udf-patterns/bounds-and-tiles)

## More Tips & Best Practices
- [UDF Best Practices](/guide/best-practices/udf-best-practices)
    - Use print statements
    - Type your inputs
- [Workbench Best Practices](/guide/best-practices/workbench-best-practices)
    - [Use `return` to quickly explore data](/guide/best-practices/workbench-best-practices#use-return-to-quickly-explore-data)
    - [Visualization tips](/guide/best-practices/workbench-best-practices#%EF%B8%8F-visualizing-results)
