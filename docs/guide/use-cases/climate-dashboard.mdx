...
Read more about installing Fused [here](/reference/python-sdk/#python-install).
...
Read more about [authenticating in Fused](/reference/python-sdk/authentication/).
...
Read more about [`fused.file_path()`](/reference/python-sdk/top-level-functions/#fusedfile_path) and [mount](/core-concepts/content-management/file-system/#mntcache-disk)
