...
- We're returning a list (`collections`) so if you run this in Workbench you'll notice nothing shows up on the map! That's also [why we print](/guide/best-practices/udf-best-practices#use-print) the first 5 rows. 

:::tip
Read through [the Best Practices](/guide/best-practices/udf-best-practices) for more handy tips on how to write efficient and easy to debug UDFs
:::
...
- Explore the Best Practices to [make the most of UDFs](/guide/best-practices/udf-best-practices) or learn handy tips to use [Workbench](/guide/best-practices/workbench-best-practices) as its fullest
