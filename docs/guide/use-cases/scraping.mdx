...
When you need to scrape data from multiple known URLs simultaneously, use the [scrapegraph multi scraper UDF](https://www.fused.io/workbench/udf/catalog/scrapegraph_multi_scraper-8aaafa63-3888-4f12-8d31-6e3f9098b2ae). This UDF creates a unified output schema across all pages and processes them in parallel using [fused.submit](/reference/python-sdk/top-level-functions/#fusedsubmit) calls.
...
**API Setup Required**: You'll need to configure your own API keys for third party services as [fused secrets](/reference/workbench/preferences#secrets-management)

## See Also

- Turning [any UDF into an API](/tutorials/Engineering%20&%20ETL/turn-your-data-into-an-api)
