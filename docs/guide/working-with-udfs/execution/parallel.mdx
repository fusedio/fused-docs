...
- 📈 Processing 20Tb of data in minutes: [Making a Climate Dashboard](/examples/climate-dashboard) of 20 years of data
- ⛴️ [Retrieving 30 days](/examples/dark-vessel-detection#33---run-this-udf-over-a-month-of-ais-data) of AIS boat transponder data around the United States to detect illegal fishing
- 🛰️ [Retrieving all of Maxar's Open Data STAC Catalogs](/examples/satellite-imagery#preparing-fusedsubmit-to-run-in-parallel) across every events they have imagery for.
