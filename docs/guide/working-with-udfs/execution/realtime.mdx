...
2.  [**HTTPS call**](/guide/data-input-outputs/export-api/tokens-endpoints) from *anywhere*
    - Useful when you want to call a UDF outside of Python. For example, receiving dataframes into Google Sheets or plotting points and images in a [Felt map](/guide/data-input-outputs/export-api/geospatial-export#felt)
...
You can get the token from a UDF either in [Workbench](/workbench/overview) (Save your UDF then click "Share") or by returning the token in Python.
