...
These parameters control how Fused structures the `bounds` object for [tile UDFs](/guide/working-with-udfs/geospatial/single-vs-tile).
...
- [How to run a Realtime job](/guide/getting-started/udf-best-practices/realtime) — walkthrough with examples
- [fused.submit](/guide/working-with-udfs/fused-submit) — run over multiple inputs in parallel
- [Caching](/guide/working-with-udfs/caching) — how caching works
