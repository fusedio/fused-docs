...
- [fused.run](/guide/working-with-udfs/fused-run) — single UDF execution
- [How to run in parallel](/guide/getting-started/udf-best-practices/parallel) — walkthrough with examples
