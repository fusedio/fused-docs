---
id: single-vs-tile
title: Single vs Tile
sidebar_label: Single vs Tile
sidebar_position: 1
---
...
A Single UDF is called like any other UDF via a [HTTPS request](/guide/working-with-udfs/execution/realtimerun-small-udfs#https-requests):
...
Will prioritize the current MAP VIEWPORT bounds, regardless of the [`bounds`](/guide/working-with-udfs/geospatial/single-vs-tile#bounds) parameter.
...
Will use the [`bounds`](/guide/working-with-udfs/geospatial/single-vs-tile#bounds) parameter, regardless of the current MAP VIEWPORT bounds.
...
A Tile UDF is called by passing [Web mercator XYZ tiles](https://en.wikipedia.org/wiki/Tiled_web_map) through the [HTTPS request](/guide/working-with-udfs/execution/realtimerun-small-udfs#https-requests)
...
| Parameters | [`bounds`](/guide/working-with-udfs/geospatial/single-vs-tile#bounds) (Optional) | [`bounds`](/guide/working-with-udfs/geospatial/single-vs-tile#bounds) or `x`, `y`, `z` |
...
This behaves the same as [`fused.types.Tile`](/guide/working-with-udfs/geospatial/single-vs-tile#legacy-fusedtypestile).
