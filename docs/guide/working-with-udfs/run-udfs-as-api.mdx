...
Every UDF can be used as a file system. [Share your canvas](/workbench/udf-builder/canvas#share-modal) to get a canvas token (`fc_***`); then call any UDF by name at `udf.ai/fc_<token>/<udf_name>.<ext>`.
