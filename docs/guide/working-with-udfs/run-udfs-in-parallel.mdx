...
- [Run UDFs in python](/guide/working-with-udfs/fused-run) — single UDF execution
- [Scaling out UDFs](/guide/working-with-udfs/udf-best-practices/scaling-out) — best practices for parallel and batch execution
