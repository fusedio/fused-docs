...
- [Run UDFs in python](/guide/working-with-udfs/run-udfs-in-python) — single UDF execution
- [How to run in parallel](/guide/working-with-udfs/udf-best-practices/parallel) — walkthrough with examples
