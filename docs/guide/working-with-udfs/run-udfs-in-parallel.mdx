...
Same as [running UDFs](/guide/working-with-udfs/running-udfs#engine). Default: `"remote"`
...
Same as [running UDFs](/guide/working-with-udfs/running-udfs#cache_max_age).
...
- [Running UDFs](/guide/working-with-udfs/running-udfs) — single UDF execution
