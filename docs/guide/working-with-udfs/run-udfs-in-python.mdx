...
See [Caching](/guide/working-with-udfs/udf-best-practices/caching#caching-a-udf) for more details on how caching works.
...
- [Run UDFs in parallel](/guide/working-with-udfs/run-udfs-in-parallel) — run over multiple inputs in parallel
