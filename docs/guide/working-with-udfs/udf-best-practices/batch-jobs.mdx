...
| Single job needs >120s or >10GB RAM | [Dedicated instance](#dedicated-instances) |
...
See [the full list of AWS / GCP instance types](/guide/working-with-udfs/fused-run#engine)
