...
You can invalidate the UDF cache programmatically — including purging specific tiles. See [Cache invalidation](cache-invalidation) for details.
...
- [Cache invalidation](cache-invalidation) — purge cached results via Python or the HTTP API
