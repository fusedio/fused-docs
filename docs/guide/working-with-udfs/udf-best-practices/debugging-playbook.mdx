...
{/* [SCREENSHOT: Workbench code editor with profiler column visible, showing per-line timing] */}
...
{/* [SCREENSHOT: Workbench results panel showing print output alongside the returned DataFrame] */}
...
{/* [SCREENSHOT: Workbench toolbar with the "Clear cache" button highlighted] */}
...
{/* [SCREENSHOT: Workbench showing the mixed results output] */}
