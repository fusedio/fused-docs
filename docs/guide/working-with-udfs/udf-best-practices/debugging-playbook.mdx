...
The examples below use `flaky_task` — a UDF that sleeps 2s and raises a `ValueError` on ~50% of runs. [Try it out](https://www.fused.io/canvas/fc_fused/debugging_udf_example) →
