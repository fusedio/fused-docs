...
To execute, UDFs first load the environment (Python, libraries). This is called a **cold start** and typically takes 10-15s.

After that, the UDF is **warm** and executes within seconds. Fused does not charge for cold start time.

![Lambda lifecycle showing cold start vs warm execution](https://docs.aws.amazon.com/images/lambda/latest/dg/images/perf-optimize-figure-1.png)
_Diagram from [AWS Lambda documentation](https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtime-environment.html)_
