...
After inactivity, Fused needs to spin up an instance and load the environment. This **cold start** typically adds **4–6s** of infrastructure startup time on top of your UDF's execution time.
...
:::tip Keep your environment warm
...
:::note Cache location
The Fused cache is hosted in `us-west-2`. If your users are in Europe, expect roughly **1–2s of added latency** for cached responses due to the round trip. This is expected behaviour and unrelated to cold starts.
:::
...
| More than 120s or ~10GB | [Dedicated instances](/guide/working-with-udfs/udf-best-practices/scaling-out#dedicated-instances) |

## See also

- [Running UDFs](/guide/working-with-udfs/fused-run) — full reference
