...
![Create checkpoint and Pull Request](/img/working-as-a-team/create_checkpoint_pr.png)
...
![Generate share token](/img/working-as-a-team/generate_share_token_steps.png)
