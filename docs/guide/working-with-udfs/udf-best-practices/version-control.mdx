...
<ul>
<li>None — revokes shared access to the canvas</li>
<li>Team — accessible only to members of the selected team</li>
<li>Public — accessible to anyone with the link, including in incognito mode</li>
</ul>

Changing the access setting automatically creates a PR on the linked repository to change <code>shared_token.json</code>. The access change takes effect only after the PR is merged.
