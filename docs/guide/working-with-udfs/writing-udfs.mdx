...
UDFs can return the following types of objects. Fused will try to convert the returned object to the [requested file format](/guide/working-with-udfs/calling-udfs-as-api#output-formats).
