...
[URL and tool inputs](/guide/data-input-outputs/export-api/tokens-endpoints) should be treated as untrusted: narrow parameters, validate identifiers, and bind query values. See [Writing secure UDFs](/guide/working-with-udfs/udf-best-practices/security).
