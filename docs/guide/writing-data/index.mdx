...
See [Geospatial File Formats](/tutorials/Geospatial%20with%20Fused/geospatial-data-ingestion/geospatial-file-formats) for details.
...
No file saving needed—just call the endpoint.
