...
| Storage | URL Prefix | Persistence |
|---------|------------|-------------|
| Your S3 bucket | `s3://` | Permanent |
| Fused Storage | `fd://` | Permanent |
| Shared Mount Disk | `/mnt/cache/` | 12 hours |
...
For complete write code snippets, see the **[Data Writing Reference](/reference/data-writing/)**.
