...
- [Best Practices](/core-concepts/best-practices/) for making the most of Fused UDFs
- [Examples](/use-cases/): Building full pipelines with ingestion, writing more complex UDFs, running & deploying them
