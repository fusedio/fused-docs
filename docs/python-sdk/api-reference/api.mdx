...
Create a [`FusedSnowflakeConnection`](#fusedsnowflakeconnection) using Fused-managed OAuth. This is a convenience shorthand for calling the constructor directly.
