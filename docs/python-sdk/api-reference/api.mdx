...
:::warning
This function is deprecated and will be removed in a future version. Use your full S3 home directory path directly (e.g., `s3://fused-users/fused/aman/my-data/output.parquet`).
:::

Resolve an `fd://` path to the full S3 URI.

**Parameters:**

- **path** (`str`) – An `fd://` path to resolve (e.g., `fd://my-data/output.parquet`).
...
# Returns: "s3://fused-users/fused/aman/my-data/output.parquet"
```
