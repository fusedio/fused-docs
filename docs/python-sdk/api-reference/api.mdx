...
```python
airtable_list_records(table: str, *, base_id: str, **params
```
...
```python
list_records(
    table: str, *, base_id: str | None = None, **params
) -> list[dict[str, Any]]
```
...
```python
execute(sql: str, *args: str, **kwargs
```
...
```python
write(df: pd.DataFrame, table: str, mode: str = 'append', **kwargs
```
