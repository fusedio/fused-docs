...
- <code>[Union](#typing.Union)\[[ResultType](#fused._run.ResultType), [UdfEvaluationResult](#fused.models.udf._eval_result.UdfEvaluationResult)\]</code> – The result of the UDF execution, which varies based on the UDF and execution path.
