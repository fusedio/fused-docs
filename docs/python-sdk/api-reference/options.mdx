...
```python
request_timeout_dev: Union[Tuple[float, float], float, None] = 25
```

Alternative request timeout for the Fused service development environments

Only used on some requests.
