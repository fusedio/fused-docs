...
:::warning
This option is deprecated along with the `fd://` scheme and will be removed in a future version. Use full S3 paths directly.
:::

If set, where `fd://` scheme URLs will resolve to. By default this is inferred from your user account.
