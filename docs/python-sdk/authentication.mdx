...
This can be helpful when calling UDFs [via HTTPS requests](/guide/working-with-udfs/execution/realtime#private-token) outside of the Fused Python SDK and Workbench to authenticate with the Fused API.
