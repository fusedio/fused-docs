...
- [Canvas](/workbench/udf-builder/canvas): sharing is now available for paid plans only; default canvases no longer generate a share token automatically; canvases can now be deleted directly from GitHub
