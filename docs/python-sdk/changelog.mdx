...
**Hugging Face & ComfyUI integrations**

Connect Hugging Face model repositories and ComfyUI workflows directly to UDFs, making it easier to build AI pipelines without moving data out of those platforms.

**Python UDF autocomplete**

The code editor now autocompletes Python UDF function names and parameters as you type, reducing errors and speeding up development.

<img
  src="https://fused-magic.s3.us-west-2.amazonaws.com/changelog_assets/v2_7_1/v_2_7_1_changelog.gif"
  alt="Python UDF autocomplete in the Fused code editor"
