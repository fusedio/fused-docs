...
General:
- Improvements to Navigation in [Command Pallette](/guide/getting-started/workbench-intro#using-keyboard-shortcuts-command-palette). Try it out in Workbench by doing `Cmd + K` (`Ctrl + K` on Windows / Linux)
