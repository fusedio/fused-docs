...
- [Experimental] Widgets: line chart and more chart types; switch layouts from a dropdown via `render`; SQL-backed widgets use a higher automatic row limit
...
- UDF collections expose an OpenAPI 3 schema; UDF kebab menu includes “Open in Swagger” (`.api`)
