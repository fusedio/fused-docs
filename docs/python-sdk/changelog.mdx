...
**New integrations: Notion and Google BigQuery**

Connect Notion pages and BigQuery datasets directly to UDFs and expose results through the Fused API.
...
- [Widgets](/guide/data-input-outputs/import-connection/widgets): Syntax validation in the builder now includes AI context
- [Widgets](/guide/data-input-outputs/import-connection/widgets): Share files via widget metadata
...
- [Canvas](/workbench/udf-builder/canvas): Edge dropdown menus and option improvements
- [Canvas](/workbench/udf-builder/canvas): Fullscreen node now fills the first two panels
- [Canvas](/workbench/udf-builder/canvas): File explorer shows file paths; search reliability improved
- Workbench: Log auto-scroll button revamped with more aggressive flushing
- Workbench: Batch job execution flow simplified
- Workbench: Open UDF results directly in hyparquet
...
See the [Snowflake integration docs](/guide/data-input-outputs/import-connection/snowflake) to get started.
...
See the [Airtable integration docs](/guide/data-input-outputs/import-connection/airtable) to get started.
