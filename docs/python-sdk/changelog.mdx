...
<img
  src="/img/changelog/v2_6_0_integrations.png"
  alt="Integrations panel on the Fused home page showing Google Drive, Slack, and GitHub"
...
- Public [collections](/guide/data-input-outputs/export-api/tokens-endpoints) now support preview images
- Home page UI polish
- `fused.submit` shows the first error before retrying; `delete_cache` renamed to `invalidate_cache`
