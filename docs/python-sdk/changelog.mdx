...
Version control your Canvases through GitHub (Under experimental feature flag)

**Improvements**
- [Experimental] Widget UI: searchable dropdown, big-number widget, bar-chart formatting
- Capture button in collapsed view
- Restore canvas parameters from checkpoints
- Canvas sort for team; favourite (star) collections
- AI: UDF rename and chat naming, keyboard handling
- Aspect ratio when pasting images to canvas

**Upgrades**
- DuckDB v1.5.0

**Bug fixes**
- No confirmation modal when importing initial canvas
- Run timer when no UDF is running
- Starting batch jobs from Workbench
- Download for non-existent files/dirs
- Checkpoints and param cascade
...
**Improvements**
- Profile page now show tokens usage
