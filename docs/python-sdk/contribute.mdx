...
{/* TODO: Edit this section with new method in Workbench */}

This section shows how to publish or update a UDF in a GitHub repository.

We recommend following these steps to keep your code organized with a readable history so the community or your team can see what you've done and why.
...
To add a UDF that was created on Fused Workbench, click ["Download"](/workbench/udf-builder/code-editor/#download) to download the UDF `.zip` to a local directory, then unzip the file. Place the resulting directory in the repo. Each UDF should have its own directory.

import ImgSdk from '@site/static/img/image-sdk.png';

<div style={{textAlign: 'center'}}>
<img src={ImgSdk} alt="File" style={{width: 600}} />
</div>
...
import ImgContribute from '@site/static/img/contribute1.png';

<div style={{textAlign: 'center'}}>
<img src={ImgContribute} alt="File" style={{width: 800}} />
</div>