---
id: get-started-prior
title: Get Started (prior)
sidebar_position: -3
...
Set up the Fused [Python SDK](/python-sdk/) in a Python Notebook or other Python environment.
...
import ImgAuth from '@site/static/img/notebook_auth.png';

<div style={{textAlign: 'center'}}>
<img src={ImgAuth} alt="File" style={{width: 800}} />
</div>


Open the link that shows up in a new window and follow the prompts to authenticate. Paste the provided credentials snippet in a new cell.

```python showLineNumbers
credentials.finalize(code="...")
```

import ImgAuthcp from '@site/static/img/notebook_auth_cp.png';

<div style={{textAlign: 'center'}}>
<img src={ImgAuthcp} alt="File" style={{width: 800}} />
</div>
...
You can run UDFs locally or from the [Public UDFs repo](https://github.com/fusedio/udfs/tree/main) without creating an account. Once you want to run custom UDFs on Fused cloud resources, you'll need an account.
...
Users may run UDFs published to the Public UDFs repo using Fused's cloud resources for free. This snippets shows how to call the ["Overture Maps Example"](https://github.com/fusedio/udfs/tree/main/public/Overture_Maps_Example) UDF with a custom `bbox` parameter.
```python showLineNumbers
import fused
