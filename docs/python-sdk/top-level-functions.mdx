...
def run(
    ...
    *args,
    ...
    dtype_out_raster: Optional[Literal["png", "tif"]] = "tif",
    dtype_out_vector: Optional[Literal["parquet", "csv", "geojson", "json"]] = "parquet",
...
Args:
    ...
    - dtype_out_raster: The output raster format. Defaults to "tif".
