...
:::note
You'll need to be [logged in](/examples/login/) with an account to be able to follow this Quickstart guide
...
<Tabs className="unique-tabs">
  ...
  <TabItem value="local" label="Locally">
    ...
    :::note
    You'll need to be [logged in](/examples/login/) to be able to run a UDF on our Fused server. 
