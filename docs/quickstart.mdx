...
You can use Streamlit components to create an app in the [App Builder](/app-builder/), found on the sidebar, after you've enabled it. You can then move from UDF builder to App Builder. 
