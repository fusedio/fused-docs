...
```
https://udf.ai/fsh...parquet?start_date=2024-01-01&end_date=2024-12-31&region=US
```

### Output Formats

```
https://udf.ai/fsh...parquet  # Parquet file
https://udf.ai/fsh...csv      # CSV file
https://udf.ai/fsh...json     # JSON
https://udf.ai/fsh...html     # HTML (Creates a standard HTML table or image)
```
...
- [Loading Data](/guide/loading-data/)
    - [Files](/guide/loading-data/files)
    - [Cloud](/guide/loading-data/cloud)
    - [Databases](/guide/loading-data/databases)
    - [Specialized](/guide/loading-data/specialized)
