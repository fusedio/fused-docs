...
Read more about [why we recommend those formats](/guide/geospatial-ingestion/geospatial-file-formats).
...
Large geospatial data might not be optimally formatted or partitioned. Fused offers a simple way to [ingest your data](/guide/geospatial-ingestion/ingest-your-data) at scale.
...
Learn more about [Fused data ingestion](/guide/geospatial-ingestion/ingest-your-data)
