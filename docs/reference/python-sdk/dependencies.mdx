...
To keep things simple, Fused maintains a single runtime image. This means that any UDF you [run](/guide/running-udfs/) will be executed with these dependencies by default
