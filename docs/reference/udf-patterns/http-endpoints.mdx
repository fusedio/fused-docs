...
sidebar_position: 4
description: Patterns for exposing UDFs as HTTP endpoints
---
...
- [HTTP Endpoints Guide](/guide/running-udfs/http-endpoints)
- [Integrations](/guide/building-apps/integrations)
