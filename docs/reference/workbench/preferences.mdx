...
- **General Preferences**: Such as theme, file formats, etc. These are also searchable from [Command Palette](/core-concepts/best-practices/workbench-best-practices/#using-keyboard-shortcuts-command-palette).
