...
On UDF Builder, UDFs can explicitly be set to run as [Tile or File](/reference/udf-patterns/bounds-and-tiles/) - or autoselect between the two if the `bounds` object is [typed](/reference/udf-patterns/bounds-and-tiles#bounds).
