...
The UDF Explorer offers a searchable collection of [User Defined Functions (UDFs)](/core-concepts/why/) that can be imported into the [UDF Builder](/workbench/udf-builder/) for editing. It facilitates sharing and discovering UDFs within teams and the broader Fused community.
