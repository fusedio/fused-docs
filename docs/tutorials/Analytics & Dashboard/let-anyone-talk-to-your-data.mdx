...
{/* TODO: This is a WIP video, edit after with latest udf.ai */}
...
<ReactPlayer 
  ...
  height="100%"
  width="100%"
  url="https://fused-magic.s3.us-west-2.amazonaws.com/workbench-walkthrough-videos/docs_rewrite/tutorials/UDF_to_MCP_to_udf.ai_compressed.mp4"
/>


### Turn a data into an MCP Server in 1min
...
3. Create a new AI Profile in the [AI Assistant](/workbench/ai-assistant/)
    ...
    - In the [AI Assistant](/workbench/ai-assistant/) click the 3 dots icon then go to "Settings"
    - Go to the "Profiles" dropdown and click "+ Add New"
    - Name this "MCP Creator"
    ...
    2. **Link**: Construct the URL using this format: `https://www.fused.io/server/v1/realtime-shared/{SHARED_TOKEN}/run/file?dtype_out_raster=png&dtype_out_vector=json`
...
5. Switch to the "MCP Creator" profile in the AI Assistant
