...
Fused UDFs allow to return data or HTML. This map was built directly using the [AI Assistant](/workbench/ai-assistant/). 
...
Because Fused UDFs are serverless, not only can the AI Assistant build the map, but you get a direct feedback seeing your results in real time!

## Want to try it yourself?

You can directly book a demo with Max, our Developer Advocate right [here](https://calendly.com/max-fused/30min)!
