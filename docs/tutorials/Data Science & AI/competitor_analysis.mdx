...
- From those intersecting BGs, computes catchment-level metrics:
    - **Population** inside the catchment as pop_sum , use
    - **Median income**
    - BG count (number of intersecting block groups by the catchment area)

You can ask the AI to do this (in a new UDF):
