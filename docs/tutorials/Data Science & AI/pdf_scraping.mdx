...
[Try it out](https://www.fused.io/server/v1/realtime-shared/fsh_5uyToLwKFbTKuCP8e0UgjA/run/file) for yourself!

<div style={{textAlign: 'center'}}>
<img 
src="/img/tutorials/data-science-ai/pdf_to_udf_app.png"
alt="PDF to UDF app" style={{width: 1200}} />
</div>
