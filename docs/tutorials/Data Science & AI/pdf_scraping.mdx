...
Try out a [hosted app](https://www.fused.io/server/v1/realtime-shared/fsh_5uyToLwKFbTKuCP8e0UgjA/run/file) for yourself:
...
<iframe 
    ...
    src="https://www.fused.io/server/v1/realtime-shared/fsh_5uyToLwKFbTKuCP8e0UgjA/run/file"
