...
- [Humanitarian Data Exchange](https://openaerialmap.org/)
...
def udf():
    ...
    s3_path = f"s3://fused-users/fused/sina/zendodo_download/{url.split('/')[-1]}" # <- Update to your fused S3 path
...
def udf():
    ...
    # RAR file path
    rar_url = "s3://fused-users/fused/max/downloading_compressed_files/Correlation_Merged2015_nc2.rar"
...
def udf():
    ...
    # Filter for files containing 'Correlation_merged20151222' in filename
...
def udf():
    ...
    rar_url = "s3://fused-users/fused/max/downloading_compressed_files/Correlation_Merged2015_nc2.rar"
    output_base = "s3://fused-users/fused/max/downloading_compressed_files/Correlation_Merged2015_nc2/" # <- change this path to yours
...
def udf():
    ...
    # ZIP file path
    zip_url = "s3://fused-users/fused/max/downloading_compressed_files/WorldCereal_2021_tc-maize-second_irrigation_confidence.zip"
...
def udf():
    ...
    zip_url = "s3://fused-users/fused/max/downloading_compressed_files/WorldCereal_2021_tc-maize-second_irrigation_confidence.zip"
    output_base = "s3://fused-users/fused/max/downloading_compressed_files/WorldCereal_extracted/" # <- change this path to yours
