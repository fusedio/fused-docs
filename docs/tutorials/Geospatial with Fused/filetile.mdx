...
**Creating a tile server**

`````bash
https://www.fused.io/.../run/tiles/{z}/{x}/{y}?dtype_out_vector=csv
`````

**Calling a specific tile**

`````bash
# Example of a tile in the center of San Francisco at zoom level 13
https://www.fused.io/.../run/tiles/13/1316/3169?dtype_out_vector=csv
`````
