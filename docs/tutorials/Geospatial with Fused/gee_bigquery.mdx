...
If your GCP Project already has the correct permissions, you can use the [`fused.secrets`](/workbench/preferences/#secrets-management) object to access your GCP secrets.
