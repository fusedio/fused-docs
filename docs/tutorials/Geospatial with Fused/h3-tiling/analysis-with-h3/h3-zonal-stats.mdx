...
Zonal statistics across raster & vector data can be quite computationally expensive. H3 on the other hand allows performing all operations as tabular data. 
