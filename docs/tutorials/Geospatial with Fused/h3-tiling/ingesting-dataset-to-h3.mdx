...
Default files (using res 14 - [example file](https://www.fused.io/workbench/files?path=s3%3A%2F%2Ffused-asset%2Fhex%2Fgeorgia_subset_4_counties_3dep_1m_res14_10_v3%2F604691848023244799.parquet)):
```
                   hex   data_avg                                         source_url  res
0  634151330858880447  71.528941  [s3://fused-asset/dem/3dep_tmn/georgia/USGS_1M...   14
1  634151330858880448  71.412385  [s3://fused-asset/dem/3dep_tmn/georgia/USGS_1M...   14
2  634151330858880449  71.334829  [s3://fused-asset/dem/3dep_tmn/georgia/USGS_1M...   14
3  634151330858880450  71.250196  [s3://fused-asset/dem/3dep_tmn/georgia/USGS_1M...   14
4  634151330858880451  71.195883  [s3://fused-asset/dem/3dep_tmn/georgia/USGS_1M...   14
```
...
def udf():
    ...
    result_extract, result_partition = fused.h3.run_ingest_raster_to_h3(
        ...
        overview_res=[9,8,7,6,5,4,3],   # Setting up overviews for resolutions 9 to 3
    )
)
```
