...
Fused Canvas allows to create dependencies between UDFs. You can leverage this to your benefit by creating a simple chain of UDF that visualizes a dataset for you
...
- Wanting to get a quick look at the data at scale by leveraging the [Tile mode](/tutorials/Geospatial%20with%20Fused/filetile/#tile-udf)
