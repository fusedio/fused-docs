...
We'll explore how we partitioned this raster datasets into H3 hexagons in a following section in [Step 4: Ingest Rasters](/tutorials/Geospatial%20with%20Fused/use-cases/Crop%20Exploration%20with%20H3/ingesting_rasters)
