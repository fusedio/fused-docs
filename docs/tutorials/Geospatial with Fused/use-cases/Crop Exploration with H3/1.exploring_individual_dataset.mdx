...
>
  <a 
    ...
    onClick={e => { e.preventDefault(); window.open("https://staging.fused.io/canvas/fc_58ODijIVSE1RfX7OHhmCix", "_blank"); }}
  >
    <video
...
>
  <video
    ...
    style={{ maxWidth: '100%', borderRadius: '10px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)', cursor: 'pointer' }}
