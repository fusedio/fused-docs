...
def udf(
    ...
    data_url: str = "https://staging.udf.ai/fsh_5Z7Qgucu8mNPsv924v1CKX/run?dtype_out_raster=png&dtype_out_vector=parquet",
    theme: str = "workbench",
...
Feel free to directly reach out to us on [Discord](https://discord.com/invite/BxS5wMzdRk) or [Linkedin](https://www.linkedin.com/company/fusedio/) if you have any questions on implementing this yourself