...
<Tabs className="unique-tabs">
  ...
  <TabItem value="local_udf" label="In a UDF run locally" default>
        ...
        Run:
        ```
        # You can run this locally with `engine='local'`
...
```python showLineNumbers
@fused.udf()
def udf(datestr:str='2023_03_29', overwrite:bool=False):
    import os
    import requests
    import io
    import zipfile
...
```python showLineNumbers
# Run this locally - not in Workbench
single_ais_month = fused.run(udf, datestr="2024_09_01")
