...
This change returns the image instead of the extent, but it returns the image all at once, because Workbench is set to ["File" mode](/tutorials/Geospatial%20with%20Fused/filetile/#single-udf) by default
