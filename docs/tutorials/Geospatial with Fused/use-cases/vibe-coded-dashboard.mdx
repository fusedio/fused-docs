...
_This is a shorter version of the [Climate Dashboard](/tutorials/Geospatial%20with%20Fused/tutorials/Geospatial%20with%20Fused/use-cases/climate-dashboard/) use case, but vibe coding our way to a timeseries dashboard!._
