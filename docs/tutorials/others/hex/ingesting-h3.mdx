...
<div style={{ display: 'flex', justifyContent: 'space-between' }}>
  <div>← <a href="/tutorials/others/hex/why-hexagons">Previous: 1. Why using Hexagons</a></div>
<div><a href="/tutorials/others/hex/aggregating-h3">Next: 3. Aggregating Data</a> →</div>
</div> 