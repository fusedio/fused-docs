...
You can use Fused's AI to help you code directly in the AI Assistant tab!
...
- Save UDF (Cmd + S)
- Click "Share"
- Click on the HTTPS link to share your deployed UDF!
...
{/* Move this to dedicated section */}
