...
Fused allows us to run a [UDF in parallel](/core-concepts/run-udfs/run-small-udfs/#running-multiple-jobs-in-parallel). So we'll process 1 month of data across hundreds of jobs:
...
You can use the AI Assistant to help you [vibe code](/tutorials/vibe-coding/) an interactive timesries of your data
