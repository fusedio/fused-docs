...
\
Click "Copy shareable link" to share the app with others or [embed it in Notion](/examples/out/notion/#2-embed-the-map-into-notion)!
...
We hope this overview gives you a glimpse of what you can build with Fused. You can continue to learn how to [get data in](/examples/in/), [transform data](/examples/transform/), and [integrate](/examples/out/) with other applications.
