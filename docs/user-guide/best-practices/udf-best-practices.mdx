...
You can find an example of using offline instances in [one of our end to end examples](/examples/dark-vessel-detection/#34---ingest-1-month-of-ais-data-into-a-geo-partitioned-format) when ingesting data into portioned cloud native formats
