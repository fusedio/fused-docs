...
## Organizing your UDFs

### Use Collections (Beta)
...
{/* TODO: Topcis to cover:
Best practices:
- Use Collection to organize your UDFs by project
- Save often so there aren't too many changes to sync each time you save collection
- Make it more manageable to go through UDFs by project, especially if you want to view different layers in the Map View
- AI Agents (in beta for now) work on 1 collection at a time. Make 1 collection per AI Agent.
 */}
