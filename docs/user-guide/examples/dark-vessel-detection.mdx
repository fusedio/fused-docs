...
```python showLineNumbers
ais_daily_parquets = [f'file:///mnt/cache/AIS/{day[:-3]}/AIS_{day[-2:]}.parquet' for day in range_of_ais_dates]
```
...
<div style={{textAlign: 'center'}}>
<img src={ImgRunRemoteLogs} alt="A simple overview of Geoparquet benefits" style={{width: 800}} />
</div>

{/* TODO: Add demo of what logs tell us in workbench */}
