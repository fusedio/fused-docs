...
Fused provides a simple way to do this with the [ingestion process](/core-concepts/data%20ingestion/). Our ingestion pipeline will then slice the dataset in order to make 
