...
<Tabs className="unique-tabs">
  <TabItem value="editor" label="Editor" default>
    ```python {8,15,17} showLineNumbers
    @fused.udf
    def udf(
        bbox: fused.types.ViewportGDF,
        bands=["vv"],
...
<Tabs className="unique-tabs">
  <TabItem value="editor" label="Editor" default>
    ```python {29-30} showLineNumbers@fused.udf
    def udf(
        bbox: fused.types.ViewportGDF,
        bands=["vv"],
        resolution=10,
