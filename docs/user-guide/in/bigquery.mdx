...
Create a UDF to set your Google [Service Account credentials](https://cloud.google.com/bigquery/docs/use-service-accounts) in your Fused UDF [Disk](/core-concepts/content-management/file-system/#mntcache-disk) in a file in the `/mnt/cache` directory.
