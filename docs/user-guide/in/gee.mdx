...
Create a UDF to set your Google [Service Account credentials](https://developers.google.com/earth-engine/guides/service_account) in your Fused UDF [Disk](/core-concepts/content-management/file-system/#mntcache-disk) in a file in the `/mnt/cache` directory.
