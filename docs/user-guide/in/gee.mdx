...
Fused interfaces <Tag color="#3399ff">Google Earth Engine</Tag> with the Python [`earthengine-api`](https://github.com/google/earthengine-api) library. This example shows how to load data from GEE [datasets](https://developers.google.com/earth-engine/datasets) into Fused UDFs and read it with xarray.
