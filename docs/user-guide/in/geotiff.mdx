...
Read a GeoTIFF with the Fused [`utils.read_tiff`](https://github.com/fusedio/udfs/blob/main/public/common/utils.py#L213) utility function, which reads a portion of a tiff file based on the spatial extent of a provided `bbox`.
