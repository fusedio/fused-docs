...
Fused loads data from the <Tag color="#3399ff">Microsoft Planetary Computer</Tag> [data catalog](https://planetarycomputer.microsoft.com/) with the Python [`pystac_client`](https://pystac-client.readthedocs.io/en/stable/) library.
