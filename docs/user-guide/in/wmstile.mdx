...
- **width** (int): Requested image width in pixels
- **height** (int): Requested image height in pixels
- **version** (str, optional): WMS version. Defaults to "1.3.0".
- **format** (str, optional): Image format to request. Defaults to "image/png".
- **crs** (str, optional): Coordinate reference system. Defaults to "EPSG:4326".
- **transparent** (bool, optional): Whether background should be transparent. Defaults to True.
