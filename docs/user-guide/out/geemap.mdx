...
Create a [TileLayer](https://ipyleaflet.readthedocs.io/en/latest/layers/tile_layer.html) to load raster tiles with an [HTTP endpoint](/core-concepts/run-udfs/run-single-udfs/#http-requests) of the [Cropland Data Layer (CDL) UDF](https://www.fused.io/workbench/catalog/CDLs_Tile_Example-a9f78d6d-4820-44ac-9032-5d19591e1a55) HTTP endpoint.
...
Create a [VectorTileLayer](https://ipyleaflet.readthedocs.io/en/latest/layers/vector_tile.html) to load Vector Tiles with an [HTTP endpoint](/core-concepts/run-udfs/run-single-udfs/#http-requests) of the Public [Overture Maps Example UDF](https://www.fused.io/workbench/catalog/Overture_Maps_Example-64071fb8-2c96-4015-adb9-596c3bac6787).
