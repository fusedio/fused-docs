...
Create [Mapbox GL JS](https://docs.mapbox.com/mapbox-gl-js/example/) maps that load data from UDF [HTTP endpoints](/core-concepts/run-udfs/run-single-udfs/#http-requests).
