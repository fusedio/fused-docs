...
Create [Mapbox GL JS](https://docs.mapbox.com/mapbox-gl-js/example/) maps that load data from UDF [HTTP endpoints](/core-concepts/run/#http-requests).
...
First, create a UDF and [generate nan HTTP nendpoint](/core-concepts/run/#http-requests).
