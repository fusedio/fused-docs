...
Microsoft [Excel](https://www.microsoft.com/en-ca/microsoft-365/excel) can load data from a UDF's [HTTP Endpoint](/core-concepts/run/#http-requests) that returns a `.csv`.
