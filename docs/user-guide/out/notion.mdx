...
Create an app and click "Copy shareable link" to get the app URL. It should look like this `https://staging.fused.io/workbench#app/s/i/fa_5GEbndYpfpxwbJxer5JjKN`.
