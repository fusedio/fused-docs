...
import ImgQgis7 from '@site/static/img/qgis-7.png';

<div style={{textAlign: 'center'}}>
<img src={ImgQgis7} alt="File" style={{width: 600}} />
</div>
...
First, on Workbench, create and save a UDF. Under the "Settings" tab, click "Share" to [generate an HTTP endpoint](/core-concepts/run/#http-requests) that can be called via HTTP requests.
