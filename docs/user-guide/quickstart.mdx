...
- [Introduction](/user-guide/quickstart/#introduction)
- [Create an account](/user-guide/quickstart/#create-an-account)
- [Connect your data](/user-guide/quickstart/#connect-your-data)
- [Create UDF to read a File](/user-guide/quickstart/#create-udf-to-read-a-file)
...
- [Next steps](/user-guide/quickstart/#next-steps)
...
Upload your data to your organization's S3 bucket with the File Explorer.
...
Navigate to a directory such as the `s3://fused-asset/infra/census_bg_us/` ([U.S. Census Block Group](https://www2.census.gov/geo/tiger/TIGER_RD18/)) and select a file. When the map is zoomed-out, you'll notice boxes showing up corresponding to the spatial extent of each file. As you zoom in, the boxes will give way to the polygons of the Census Block Groups. Clicking on individual files will show the polygons they contain.
