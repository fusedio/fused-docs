...
{/* TODO: This example is also broken, that Overture_Nsi UDF is doesn't have utils anymore & no UDF has load_overture_gdf anymore */}

```python showLineNumbers
@fused.udf
def udf(bounds: fused.types.Bounds=None):
    # Import utility functions
    utils = fused.load("https://github.com/fusedio/udfs/tree/6a5e53b/public/Overture_Nsi").utils
