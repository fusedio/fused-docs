...
{/* NOTE: This should link to a public UDF */}
{/* Public UDF should take:
- raster path
- stats_type
- h3_res
- height_scale
...
Things to check:
- What is multiple bands? I.e. RGB color image? Currently only works with single band raster (i.e. elevation)
