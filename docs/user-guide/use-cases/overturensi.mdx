...
def udf(bounds: fused.types.Bounds = None):
    ...
    nsi_overture_utils = fused.load("https://github.com/fusedio/udfs/tree/9c5c8bf/public/Nsi_Overture").utils
    
    bbox = common.get_tiles(bounds, target_num_tiles=2)
    gdf_overture = nsi_overture_utils.load_overture_gdf(bbox, overture_type="building")
    gdf_nsi = nsi_overture_utils.load_nsi_gdf(bbox)
