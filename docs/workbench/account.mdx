...
Configure your account's runtime and secrets in the configuration page. To access this page, click on the account icon in the bottom-left corner of the page. Then, within the Workbench section, click on Environment.
 ...
 <ReactPlayer playsinline={true} className="video__player" playing={false} muted={true} controls height="100%" url="https://fused-magic.s3.us-west-2.amazonaws.com/workbench-walkthrough-videos/docs_rewrite/account_page3.mp4" width="100%" />
