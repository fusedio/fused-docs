...
- Creating [Interactive charts](/examples/interactive-charts) with AI
- Ask AI to help you configure [sharable HTML maps](/guide/working-with-udfs/building-outputs/standalone-maps)