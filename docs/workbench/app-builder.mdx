...
_Introducing the Fused app builder_

Transform your data into interactive, scalable, and shareable web apps in minutes. The Fused app builder combines Fused UDFs with a slick frontend experience - all in Python. 

## Key features

The app builder runs stlite and Pyodide entirely in-browser - which results in serverless Streamlit running entirely on the browser. This architecture empowers teams to harness powerful features such as:
