...
For many geospatial applications you will want to add a map to your Fused App, especially if your UDF returns a [Map `Tile`](/guide/working-with-udfs/geospatial/single-vs-tile#tile-udf).
...
:::note
    ...
    Read more about `fused.run` in the [dedicated section](/guide/getting-started/udf-best-practices/realtime#fusedrun)
:::
