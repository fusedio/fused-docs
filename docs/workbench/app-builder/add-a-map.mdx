...
For many geospatial applications you will want to add a map to your Fused App, especially if your UDF returns a [Map `Tile`](/tutorials/Geospatial%20Analysis%20in%20Fused/filetile/#tile).
