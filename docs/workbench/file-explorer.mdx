...
<div className="video__wrapper" style={{ maxWidth: "800px", margin: "0 auto" }}>
  <LazyReactPlayer
    url="https://fused-magic.s3.us-west-2.amazonaws.com/workbench-walkthrough-videos/docs_rewrite/file_explorer_intro9.mp4"
    playsinline={true}
    controls={true}
    muted={true}
    playing={false}
