...
The Fused File Explorer enhances how you browse and manage files in S3 buckets. Quickly list file contents, preview them on a map, and open them as Fused UDFs.
...
- Preview: Save resources and preview a dataset's spatial extent with a bounding box. 
