...
<LazyReactPlayer wrapperStyle={{ maxWidth: "800px", margin: "0 auto" }} url="https://fused-magic.s3.us-west-2.amazonaws.com/workbench-walkthrough-videos/docs_rewrite/file_explorer_intro10.mp4" />
...
Click on a file to preview its content. If the file has a spatial component, it will be displayed on the [map](/workbench/udf-builder/canvas), allowing you to zoom and pan to explore the rendered data. For images or other file types, Fused will make a best-effort to render and display the content.
