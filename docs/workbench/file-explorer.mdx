...
The Fused File Explorer is an intuitive tool to browse and manage files stored in an S3 bucket. It provides powerful features to quickly preview file contents on a map, and open Parquet tables & individual files directly as Fused UDFs.
