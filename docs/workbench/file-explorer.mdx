...
The File Explorer provides a streamlined interface to browse, preview, and open files in cloud object storage and the [mounted disk](/guide/advanced-setup/file-system/#mntcache-disk). Fused supports Amazon S3 and Google Cloud Storage, with more integrations coming soon.
