...
```
    ...
    <div style={{ width: '50%', display: 'flex', justifyContent: 'center', alignItems: 'center', height: 'auto' }}>
...
import ImgSingleColor from '/img/viz_single.png';
...
import ImgProperty from '/img/viz_property.png';
...
import ImgCategory from '/img/viz_category.png';
...
import ImgContinuous from '/img/viz_continuous.png';
