...
Once on the Workbench, click the “Add UDF” button to create a new UDF or dive into the extensive library by searching the UDF Catalog modal. You can search by tag, title, or dataset. Find the UDF that suits your needs and clone it to your workspace.
