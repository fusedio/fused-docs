...
- **General Preferences**: Such as theme, file formats, etc. These are also searchable from [Command Palette](/guide/getting-started/workbench-intro#using-keyboard-shortcuts-command-palette).
