...
The Cache option is now available under the Share section. To access it, click Configure within the Share menu.
...
import ImgCache from '@site/static/img/workbench/udf-builder/cache.png';

<div style={{textAlign: 'center'}}>
<img src={ImgCache} alt="File" style={{width: '80%'}} />
</div>
...
The Default View State option is now available under Expand Parameters.

It can be set automatically to match the current map view or configured manually.

import Imgdefaultviewstate from '@site/static/img/workbench/udf-builder/default_view.png';
