...
The Code Editor is where developers write UDFs using [standard Python libraries](/python-sdk/dependencies/). It has a Editor, Module, Visualize, and Settings tab to help organize code, create HTTP endpoints, and configure the UDF.
...
## Generate endpoints with Workbench * move this section to workbench,
...
{/* ## TODO: move this section to workbench, especially the image. */}
