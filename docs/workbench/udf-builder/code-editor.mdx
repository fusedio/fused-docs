...
- Running the same UDF twice might lead to different runtimes especially if you call [cached functions](/guide/working-with-udfs/udf-best-practices/caching/#caching-any-python-function-fusedcache) or [cached UDFs](/guide/working-with-udfs/udf-best-practices/caching/#caching-a-udf).
