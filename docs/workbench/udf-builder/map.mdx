...
For UDFs that return [map Tiles](/tutorials/Geospatial%20Analysis%20in%20Fused/filetile/#tile), Fused runs the UDF for only the Tiles in the viewport. This enables efficient analysis on a fraction of a dataset.
