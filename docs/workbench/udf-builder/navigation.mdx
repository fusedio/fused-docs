...
The "Shared token" section shows snippets to run the UDF using a public token. This allows any application to invoke the UDF without authentication - including `cURL` calls, [Lonboard](/examples/out/lonboard/), [Leaflet](/examples/out/leaflet/), [Mapbox](/examples/out/mapbox/), [Google Sheets](/examples/out/googlesheets/), [DuckDB](/examples/out/duckdb/), the Fused [App Builder](/workbench/app-builder/), and Python applications with [`fused.run`](/core-concepts/run-udfs/).
