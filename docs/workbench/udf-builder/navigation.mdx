...
The "Shared token" section shows snippets to run the UDF using a public token. This allows any application to invoke the UDF without authentication - including `cURL` calls, [Lonboard](/tutorials/others/out/lonboard/), [Leaflet](/tutorials/others/out/leaflet/), [Mapbox](/tutorials/others/out/mapbox/), [Google Sheets](/tutorials/others/out/googlesheets/), [DuckDB](/tutorials/others/out/duckdb/), the Fused [App Builder](/workbench/app-builder/), and Python applications with [`fused.run`](/core-concepts/run-udfs/).
