...
When a UDF runs as [Tile](/core-concepts/filetile/#map-tiles), this last tab shows a GeoJSON with the geometry and properties for the `bounds` object the UDF was called with.
