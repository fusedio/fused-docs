...
If you're using `map_utils` to build standalone maps in Canvas, see [Standalone Maps](/guide/working-with-udfs/building-outputs/standalone-maps) instead. This page covers styling for UDF Builder layers.
:::
