...
If you're using `map_utils` to build standalone maps in Canvas, see [Standalone Maps](/examples/building-outputs/standalone-maps) instead. This page covers styling for UDF Builder layers.
:::
