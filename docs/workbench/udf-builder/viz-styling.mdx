...
Fused works with on a either a File or Tile basis (read more about this [here](/tutorials/Geospatial%20Analysis%20in%20Fused/filetile/)). The styling will differ for each:
