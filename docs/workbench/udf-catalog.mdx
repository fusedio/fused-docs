...
The UDF Explorer offers a searchable collection of [User Defined Functions (UDFs)](/guide/getting-started/first-udf-basics) that can be imported into the [Map Builder](/workbench/udf-builder/canvas) for editing. It facilitates sharing and discovering UDFs within teams and the broader Fused community.
