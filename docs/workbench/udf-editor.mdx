...
You can read more about the difference between the two types of outputs in the [core concepts section](/basics/core-concepts/#udf-execution-modes-file-tile).
