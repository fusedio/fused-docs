...
This can be helpful when calling UDFs [via HTTPS requests](/core-concepts/run-udfs/run-small-udfs/#private-token) outside of the Fused Python SDK and Workbench to authenticate with the Fused API.
