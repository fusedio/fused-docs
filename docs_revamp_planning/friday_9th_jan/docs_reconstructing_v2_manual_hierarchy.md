### Taking reconstructed plan from Wed, moving into implementing every single page
...
│   │   └── geospatial-data/     # (Manually moving around)
│   │       ├── stac.mdx             # STAC Catalogs
│   │       ├── gee.mdx              # Google Earth Engine
│   │       └── ingesting-large-datasets.mdx # fused.ingest() section
│   │       └── recommended-file-formats.mdx     # When to use what format
│   │
# Missing section about running UDFs / Processing
