  ...
  apiReferenceSidebar: [
    ...
    
    {
      ...
      items: [
        ...
        { type: "doc", id: "python-sdk/api-reference/udf", label: "Udf" },
        { type: "doc", id: "python-sdk/api-reference/jobpool", label: "JobPool" },
        {
          type: "category",
          label: "Top-Level Functions",
          collapsible: true,
          collapsed: false,
          items: [{ type: "autogenerated", dirName: "python-sdk/api-reference/top-level" }],
        },
        { type: "doc", id: "python-sdk/api-reference/api", label: "fused.api" },
        { type: "doc", id: "python-sdk/api-reference/context", label: "fused.context" },
        { type: "doc", id: "python-sdk/api-reference/h3", label: "fused.h3" },
        { type: "doc", id: "python-sdk/api-reference/options", label: "fused.options" },
        { type: "doc", id: "python-sdk/api-reference/types", label: "fused.types" },
        { type: "doc", id: "python-sdk/api-reference/secrets", label: "fused.secrets" },
      ],
    },
