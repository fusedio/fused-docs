  ...
  tutorialSidebar: [
    "index",
    {
      ...
      items: [ 
          ...
          items: [
            {
              ...
              collapsed: false,
              items: [{ type: "autogenerated", dirName: "user-guide/transform/geospatial" }],
            },
            {
              type: "category",
              label: 'Generic data',
              ...
              collapsed: true,
              items: [{ type: "autogenerated", dirName: "user-guide/transform/generic" }],
            },
          ],
        },
        {
        ...
        //   link: { type: "doc", id: "user-guide/case-studies" },
        //   items: [{ type: "autogenerated", dirName: "user-guide/case-studies" }],
        // },        
      ],
    },
    {
