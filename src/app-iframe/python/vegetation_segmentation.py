...
available_indices = [
    ...
    'CIVE: Color Index of Vegetation Extraction',  # Color Index of Vegetation Extraction
    'VIgreen: Vegetative Index (VIgreen)',  # Vegetative Index (VIgreen)
...
index_min, index_max = st.slider("Morphological Kernel Size (odd number)",
                                 min_value=0.0,
                                 max_value=1.0,
                                 value=(0.1, 0.9),
                                 step=0.01)
    ...
    <script>
      ...
      new DeckGL({{
        ...
        layers: [
          new TileLayer({{
            id: "base",
            data: "https://staging.fused.io/server/v1/realtime-shared/fsh_7MDUq8kscLii9MhiTvuU8o/run/tiles/{{z}}/{{x}}/{{y}}?dtype_out_raster=png&index_min={index_min}&index_max={index_max}&index_method={index_method}&return_mask={False}",
            maxZoom: 25,
            minZoom: 0,
          ...
          new TileLayer({{
            id: "data",
            data: "https://staging.fused.io/server/v1/realtime-shared/fsh_7MDUq8kscLii9MhiTvuU8o/run/tiles/{{z}}/{{x}}/{{y}}?dtype_out_raster=png&index_min={index_min}&index_max={index_max}&index_method={index_method}&return_mask={mask}",
            maxZoom: 25,
            minZoom: 0,
